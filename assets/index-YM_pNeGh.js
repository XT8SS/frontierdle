        ...
        <img src="misc/kofi-badge.png" alt="" class="svelte-1aydprt"/></a>`,s=w(),r=g("button"),r.innerHTML='<iconify-icon icon="material-symbols:help-outline-rounded"></iconify-icon> <span class="tooltip" id="left">Help</span>',o=w(),l=g("button"),a=g("iconify-icon"),c=w(),u=g("span"),u.textContent="Changelog",h=w(),C&&C.c(),d=w(),p=g("button"),p.innerHTML='<iconify-icon icon="material-symbols:policy-outline-rounded"></iconify-icon> <span class="tooltip" id="left">Policy</span>',m=w(),v=g("span"),b=z(n[0]),_(e,"class","info p-1 svelte-1aydprt"),_(e,"id","credits"),_(i,"class","info p-1 svelte-1aydprt"),_(i,"id","donate"),_(r,"class","info p-1 svelte-1aydprt"),_(r,"id","help"),xe(a,"icon","octicon:log-16"),_(u,"class","tooltip"),_(u,"id","right"),_(l,"class","info svelte-1aydprt"),_(l,"id","changelog"),_(p,"class","info p-1 svelte-1aydprt"),_(p,"id","policy"),_(v,"class","info svelte-1aydprt"),_(v,"id","version")},m(S,N){T(S,e,N),T(S,t,N),T(S,i,N),T(S,s,N),T(S,r,N),T(S,o,N),T(S,l,N),f(l,a),f(l,c),f(l,u),f(l,h),C&&C.m(l,null),T(S,d,N),T(S,p,N),T(S,m,N),T(S,v,N),f(v,b),D||(F=[De(e,"click",n[3]),De(r,"click",n[4]),De(l,"click",n[5]),De(p,"click",n[6])],D=!0)},p(S,[N]){S[2]?C&&(lt(),he(C,1,1,()=>{C=null}),at()):C?N&4&&Z(C,1):(C=Lo(),C.c(),Z(C,1),C.m(l,null)),N&1&&pe(b,S[0])},i(S){Z(C)},o(S){he(C)},d(S){S&&(I(e),I(t),I(i),I(s),I(r),I(o),I(l),I(d),I(p),I(m),I(v)),C&&C.d(),D=!1,Je(F)}}}function cp(n,e,t){let i,s;Ne(n,qe,u=>t(1,i=u)),Ne(n,jn,u=>t(2,s=u));let{version:r}=e;const o=u=>{tn(u),ue(qe,i.component=Q_,i)},l=u=>{tn(u),ue(qe,i.component=rp,i)},a=u=>{tn(u),ue(qe,i.component=Y_,i),ue(jn,s=!0,s)},c=u=>{tn(u),ue(qe,i.component=lp,i)};return n.$$set=u=>{"version"in u&&t(0,r=u.version)},[r,i,s,o,l,a,c]}class up extends st{constructor(e){super(),it(this,e,cp,ap,Xe,{version:0})}}const{document:oi}=Ya;function Fo(n,e,t){const i=n.slice();return i[60]=e[t],i}function xo(n,e,t){const i=n.slice();return i[60]=e[t],i}function Wo(n){let e;return{c(){e=g("link"),_(e,"rel","preload"),_(e,"as","image"),_(e,"href",n[60])},m(t,i){T(t,e,i)},p:re,d(t){t&&I(e)}}}function Bo(n){let e;return{c(){e=g("style"),e.textContent=`*:not(.promptCont, .promptCont *) {
            ...
            .info:not(#zoomLevel, #version) {
                ...
                pointer-events: none;
                    ...
                    <br/>
                    No stat / avg. cost / color clues</span>`,B=w(),te=g("span"),te.textContent="Nightmare Mode",Y=w(),ct(P.$$.fragment),H=w(),j&&j.c(),E=w(),ee&&ee.c(),U=w(),ct(M.$$.fragment),de=w(),ge&&ge.c(),ie=w(),A&&A.c(),q=w(),ae&&ae.c(),ne=kt(),xe(r,"icon",o="f7:speaker-"+(n[4].muted?"slash":"2")+"-fill"),xe(r,"class","svelte-247i5i"),_(a,"class","tooltip"),_(a,"id","bottom"),_(s,"class","flex light-hover svelte-247i5i"),_(i,"class","iconToggle ff-bg posrel border-tp br-1 bs svelte-247i5i"),Ge(p.src,m="frontierdle.svg")||_(p,"src",m),_(p,"alt","Frontierdle"),_(p,"class","svelte-247i5i"),S.a=null,_(b,"class","tooltip svelte-247i5i"),_(b,"id","bottom"),_(d,"class","iconCont ff-bg posrel border-tp br-1 bs no-bg-change svelte-247i5i"),_(x,"class","flex posrel light-hover svelte-247i5i"),_(R,"class","iconToggle ff-bg border-tp br-1 bs svelte-247i5i"),_(t,"class","upperMenu flex fai-center svelte-247i5i"),_(W,"class","flex posrel no-bg-change"),_(K,"class","hardModeCont ff-bg flex fai-center border-tp br-1 bs svelte-247i5i"),_(e,"class","flex fd-col fai-center posrel svelte-247i5i")},m(G,ve){T(G,e,ve),f(e,t),f(t,i),f(i,s),f(s,r),f(s,l),f(s,a),f(a,u),f(t,h),f(t,d),f(d,p),f(d,v),f(d,b),f(b,D),f(b,F),f(b,C),S.m(N,b),f(t,$),f(t,R),f(R,x),f(e,Q),f(e,K),f(K,W),f(K,B),f(K,te),f(K,Y),tt(P,K,null),f(e,H),j&&j.m(e,null),f(e,E),ee&&ee.m(e,null),f(e,U),tt(M,e,null),f(e,de),ge&&ge.m(e,null),T(G,ie,ve),A&&A.m(G,ve),T(G,q,ve),ae&&ae.m(G,ve),T(G,ne,ve),le=!0,O||(J=[De(s,"click",n[35]),De(x,"click",n[36])],O=!0)},p(G,ve){(!le||ve[0]&16&&o!==(o="f7:speaker-"+(G[4].muted?"slash":"2")+"-fill"))&&xe(r,"icon",o),(!le||ve[0]&16)&&c!==(c=G[4].muted?"Muted":"Unmuted")&&pe(u,c),(!le||ve[0]&917504)&&N!==(N=Ai(G[17],G[18],G[19])+"")&&S.p(N);const gt={};ve[0]&16&&(gt.checked=G[4].hardMode),ve[0]&32&&(gt.disabled=G[5].chosenItems.length!=0),P.$set(gt),!G[5].gameWin&&!G[5].gameOver?j?(j.p(G,ve),ve[0]&32&&Z(j,1)):(j=Go(G),j.c(),Z(j,1),j.m(e,E)):j&&(lt(),he(j,1,1,()=>{j=null}),at()),G[5].gameWin||G[5].gameOver?ee?(ee.p(G,ve),ve[0]&32&&Z(ee,1)):(ee=zo(G),ee.c(),Z(ee,1),ee.m(e,U)):ee&&(lt(),he(ee,1,1,()=>{ee=null}),at());const _e={};!me&&ve[0]&1024&&(me=!0,_e.dailyItemData=G[10],Oi(()=>me=!1)),M.$set(_e),G[11]?ge?ge.p(G,ve):(ge=jo(G),ge.c(),ge.m(e,null)):ge&&(ge.d(1),ge=null),G[21].component&&G[21].complete?A?(A.p(G,ve),ve[0]&2097152&&Z(A,1)):(A=Vo(G),A.c(),Z(A,1),A.m(q.parentNode,q)):A&&(lt(),he(A,1,1,()=>{A=null}),at()),G[21].component&&!G[21].complete?ae?(ae.p(G,ve),ve[0]&2097152&&Z(ae,1)):(ae=qo(G),ae.c(),Z(ae,1),ae.m(ne.parentNode,ne)):ae&&(lt(),he(ae,1,1,()=>{ae=null}),at())},i(G){le||(Z(P.$$.fragment,G),Z(j),Z(ee),Z(M.$$.fragment,G),Z(A),Z(ae),le=!0)},o(G){he(P.$$.fragment,G),he(j),he(ee),he(M.$$.fragment,G),he(A),he(ae),le=!1},d(G){G&&(I(e),I(ie),I(q),I(ne)),nt(P),j&&j.d(),ee&&ee.d(),nt(M),ge&&ge.d(),A&&A.d(G),ae&&ae.d(G),O=!1,Je(J)}}}function Go(n){let e,t,i;function s(o){n[38](o)}let r={};return n[16]!==void 0&&(r.gameNumber=n[16]),e=new F_({props:r}),Ze.push(()=>Mi(e,"gameNumber",s)),{c(){ct(e.$$.fragment)},m(o,l){tt(e,o,l),i=!0},p(o,l){const a={};!t&&l[0]&65536&&(t=!0,a.gameNumber=o[16],Oi(()=>t=!1)),e.$set(a)},i(o){i||(Z(e.$$.fragment,o),i=!0)},o(o){he(e.$$.fragment,o),i=!1},d(o){nt(e,o)}}}function zo(n){let e,t,i=n[5].gameWin?"Fantastic!":"Farewell...",s,r,o,l,a,c=n[5].gameWin?"won":"lost",u,h,d,p,m,v,b,D,F,C,S,N,$,R,x=n[10].name+"",Q,K,W,B,te,Y,P,H=Ai(n[17],n[18],n[19])+"",E,U,M,me,de,ie,q;function ne(O){n[39](O)}let le={};return n[16]!==void 0&&(le.gameNumber=n[16]),M=new B_({props:le}),Ze.push(()=>Mi(M,"gameNumber",ne)),ie=new $a({}),{c(){e=g("div"),t=g("span"),s=z(i),r=w(),o=g("img"),a=z(`
                    ...
                    `),te=g("br"),Y=w(),P=g("span"),U=w(),ct(M.$$.fragment),de=w(),ct(ie.$$.fragment),Ge(o.src,l=n[5].gameWin?"ff-images/rb-fantastic.png":"ff-images/rb-farewell.png")||_(o,"src",l),_(o,"id","gameFinishIcon"),_(o,"alt",""),_(o,"class","svelte-247i5i"),_(t,"class","flex fai-center svelte-247i5i"),_(t,"id","gameFinishMessage"),_(p,"class","smaller-fs"),Ge(D.src,F=Lt+n[10].image)||_(D,"src",F),_(D,"alt",""),_(D,"class","svelte-247i5i"),xe(S,"icon","tabler:link"),xe(S,"class","svelte-247i5i"),_(b,"class","flex fjc-center fai-center svelte-247i5i"),_(b,"href",N=pn+n[10].link),_(b,"target","_blank"),_(v,"class","itemImg ff-item flex svelte-247i5i"),_(v,"id","dailyItemImg"),_(R,"class","ff-item itemName svelte-247i5i"),_(R,"id","dailyItemName"),_(P,"class","ff-item svelte-247i5i"),_(P,"id","nextItemTime"),_(W,"class","flex fd-col svelte-247i5i"),_(W,"id","nextItemCont"),_(e,"class","gameFinishCont ff-bg flex fd-col fai-center border-tp br-1 bs svelte-247i5i")},m(O,J){T(O,e,J),f(e,t),f(t,s),f(t,r),f(t,o),f(t,a),f(t,u),f(t,h),f(e,d),f(e,p),f(e,m),f(e,v),f(v,b),f(b,D),f(b,C),f(b,S),f(e,$),f(e,R),f(R,Q),f(e,K),f(e,W),f(W,B),f(W,te),f(W,Y),f(W,P),P.innerHTML=H,T(O,U,J),tt(M,O,J),T(O,de,J),tt(ie,O,J),q=!0},p(O,J){(!q||J[0]&32)&&i!==(i=O[5].gameWin?"Fantastic!":"Farewell...")&&pe(s,i),(!q||J[0]&32&&!Ge(o.src,l=O[5].gameWin?"ff-images/rb-fantastic.png":"ff-images/rb-farewell.png"))&&_(o,"src",l),(!q||J[0]&32)&&c!==(c=O[5].gameWin?"won":"lost")&&pe(u,c),(!q||J[0]&1024&&!Ge(D.src,F=Lt+O[10].image))&&_(D,"src",F),(!q||J[0]&1024&&N!==(N=pn+O[10].link))&&_(b,"href",N),(!q||J[0]&1024)&&x!==(x=O[10].name+"")&&pe(Q,x),(!q||J[0]&917504)&&H!==(H=Ai(O[17],O[18],O[19])+"")&&(P.innerHTML=H);const j={};!me&&J[0]&65536&&(me=!0,j.gameNumber=O[16],Oi(()=>me=!1)),M.$set(j)},i(O){q||(O&&Ae(()=>{q&&(E||(E=we(e,bt,{duration:150},!0)),E.run(1))}),Z(M.$$.fragment,O),Z(ie.$$.fragment,O),q=!0)},o(O){O&&(E||(E=we(e,bt,{duration:150},!1)),E.run(0)),he(M.$$.fragment,O),he(ie.$$.fragment,O),q=!1},d(O){O&&(I(e),I(U),I(de)),O&&E&&E.end(),nt(M,O),nt(ie,O)}}}function jo(n){let e,t,i,s,r,o,l,a,c,u,h,d=n[11].name+"",p;return{c(){e=g("div"),t=z(`Yesterday's item was...
                `),i=g("div"),s=g("a"),r=g("img"),l=w(),a=g("iconify-icon"),u=w(),h=g("span"),p=z(d),Ge(r.src,o=Lt+n[11].image)||_(r,"src",o),_(r,"alt",""),_(r,"class","svelte-247i5i"),xe(a,"icon","tabler:link"),xe(a,"class","svelte-247i5i"),_(s,"class","flex fjc-center fai-center svelte-247i5i"),_(s,"href",c=pn+n[11].link),_(s,"target","_blank"),_(i,"class","itemImg ff-item flex svelte-247i5i"),_(i,"id","previousItemImg"),_(h,"class","ff-item itemName svelte-247i5i"),_(h,"id","previousItemName"),_(e,"class","previousItemCont ff-bg flex fd-col fai-center border-tp br-1 bs svelte-247i5i")},m(m,v){T(m,e,v),f(e,t),f(e,i),f(i,s),f(s,r),f(s,l),f(s,a),f(e,u),f(e,h),f(h,p)},p(m,v){v[0]&2048&&!Ge(r.src,o=Lt+m[11].image)&&_(r,"src",o),v[0]&2048&&c!==(c=pn+m[11].link)&&_(s,"href",c),v[0]&2048&&d!==(d=m[11].name+"")&&pe(p,d)},d(m){m&&I(e)}}}function Vo(n){let e,t,i,s,r;var o=n[21].component;function l(a,c){return{props:{prompted:!0}}}return o&&(t=ai(o,l())),{c(){e=g("div"),t&&ct(t.$$.fragment),_(e,"class","promptCont")},m(a,c){T(a,e,c),t&&tt(t,e,null),n[41](e),i=!0,s||(r=De(e,"click",n[42]),s=!0)},p(a,c){if(c[0]&2097152&&o!==(o=a[21].component)){if(t){lt();const u=t;he(u.$$.fragment,1,0,()=>{nt(u,1)}),at()}o?(t=ai(o,l()),ct(t.$$.fragment),Z(t.$$.fragment,1),tt(t,e,null)):t=null}},i(a){i||(t&&Z(t.$$.fragment,a),i=!0)},o(a){t&&he(t.$$.fragment,a),i=!1},d(a){a&&I(e),t&&nt(t),n[41](null),s=!1,r()}}}function qo(n){let e,t,i,s,r,o,l;var a=n[21].component;function c(u,h){return{props:{prompted:!0}}}return a&&(i=ai(a,c())),{c(){e=g("div"),t=g("div"),i&&ct(i.$$.fragment),_(t,"class","flex fd-col border-tp br-1 bs"),_(e,"class","promptCont")},m(u,h){T(u,e,h),f(e,t),i&&tt(i,t,null),n[43](e),r=!0,o||(l=De(e,"click",n[44]),o=!0)},p(u,h){if(h[0]&2097152&&a!==(a=u[21].component)){if(i){lt();const d=i;he(d.$$.fragment,1,0,()=>{nt(d,1)}),at()}a?(i=ai(a,c()),ct(i.$$.fragment),Z(i.$$.fragment,1),tt(i,t,null)):i=null}},i(u){r||(i&&Z(i.$$.fragment,u),u&&Ae(()=>{r&&(s||(s=we(t,Me,{duration:200},!0)),s.run(1))}),r=!0)},o(u){i&&he(i.$$.fragment,u),u&&(s||(s=we(t,Me,{duration:200},!1)),s.run(0)),r=!1},d(u){u&&I(e),i&&nt(i),u&&s&&s.end(),n[43](null),o=!1,l()}}}function hp(n){let e,t,i,s,r,o,l,a,c,u,h,d,p,m,v,b,D,F,C,S,N,$,R,x,Q;Ae(n[31]);let K=ye(n[25]),W=[];for(let E=0;E<K.length;E+=1)W[E]=Wo(xo(n,K,E));let B=n[21].component&&Bo(),te=ye(n[25]),Y=[];for(let E=0;E<te.length;E+=1)Y[E]=Ho(Fo(n,te,E));let P=n[9]&&Uo(n);S=new up({props:{version:Ns}});let H=n[7]&&n[6]&&n[8]&&$o(n);return{c(){for(let E=0;E<W.length;E+=1)W[E].c();e=kt(),B&&B.c(),t=kt(),i=w(),s=g("div"),r=g("audio"),a=w(),c=g("audio"),d=w(),p=g("audio"),b=w(),D=g("div");for(let E=0;E<Y.length;E+=1)Y[E].c();F=w(),P&&P.c(),C=w(),ct(S.$$.fragment),N=w(),H&&H.c(),$=kt(),Ge(r.src,o="audio/lucky.mp3")||_(r,"src",o),r.muted=l=n[4].muted,Ge(c.src,u="audio/farewell.mp3")||_(c,"src",u),c.muted=h=n[4].muted,Ge(p.src,m="audio/heDidItAgain.mp3")||_(p,"src",m),p.muted=v=n[4].muted,_(D,"class","backgrounds")},m(E,U){for(let M=0;M<W.length;M+=1)W[M]&&W[M].m(oi.head,null);f(oi.head,e),B&&B.m(oi.head,null),f(oi.head,t),T(E,i,U),T(E,s,U),f(s,r),n[32](r),f(s,a),f(s,c),n[33](c),f(s,d),f(s,p),n[34](p),T(E,b,U),T(E,D,U);for(let M=0;M<Y.length;M+=1)Y[M]&&Y[M].m(D,null);T(E,F,U),P&&P.m(E,U),T(E,C,U),tt(S,E,U),T(E,N,U),H&&H.m(E,U),T(E,$,U),R=!0,x||(Q=[De(window,"storage",n[28]),De(window,"wheel",n[29],{passive:!1}),De(window,"keydown",n[30]),De(window,"resize",n[31])],x=!0)},p(E,U){if(U[0]&33554432){K=ye(E[25]);let M;for(M=0;M<K.length;M+=1){const me=xo(E,K,M);W[M]?W[M].p(me,U):(W[M]=Wo(me),W[M].c(),W[M].m(e.parentNode,e))}for(;M<W.length;M+=1)W[M].d(1);W.length=K.length}if(E[21].component?B||(B=Bo(),B.c(),B.m(t.parentNode,t)):B&&(B.d(1),B=null),(!R||U[0]&16&&l!==(l=E[4].muted))&&(r.muted=l),(!R||U[0]&16&&h!==(h=E[4].muted))&&(c.muted=h),(!R||U[0]&16&&v!==(v=E[4].muted))&&(p.muted=v),U[0]&34603008){te=ye(E[25]);let M;for(M=0;M<te.length;M+=1){const me=Fo(E,te,M);Y[M]?Y[M].p(me,U):(Y[M]=Ho(me),Y[M].c(),Y[M].m(D,null))}for(;M<Y.length;M+=1)Y[M].d(1);Y.length=te.length}E[9]?P?(P.p(E,U),U[0]&512&&Z(P,1)):(P=Uo(E),P.c(),Z(P,1),P.m(C.parentNode,C)):P&&(lt(),he(P,1,1,()=>{P=null}),at()),E[7]&&E[6]&&E[8]?H?(H.p(E,U),U[0]&448&&Z(H,1)):(H=$o(E),H.c(),Z(H,1),H.m($.parentNode,$)):H&&(lt(),he(H,1,1,()=>{H=null}),at())},i(E){R||(Z(P),Z(S.$$.fragment,E),Z(H),R=!0)},o(E){he(P),he(S.$$.fragment,E),he(H),R=!1},d(E){E&&(I(i),I(s),I(b),I(D),I(F),I(C),I(N),I($)),Ye(W,E),I(e),B&&B.d(E),I(t),n[32](null),n[33](null),n[34](null),Ye(Y,E),P&&P.d(E),nt(S,E),H&&H.d(E),x=!1,Je(Q)}}}let Ns="v1.0.0";function Ai(n,e,t){return`${(n<10?"0":"")+n}<b> : </b>${(e<10?"0":"")+e}<b> : </b>${(t<10?"0":"")+t}`}function fp(n,e,t){let i,s,r,o,l,a,c,u;Ne(n,ut,y=>t(3,i=y)),Ne(n,Tt,y=>t(4,s=y)),Ne(n,Di,y=>t(27,r=y)),Ne(n,ot,y=>t(5,o=y)),Ne(n,lo,y=>t(6,l=y)),Ne(n,ks,y=>t(7,a=y)),Ne(n,jn,y=>t(50,c=y)),Ne(n,qe,y=>t(21,u=y));let h,d,p=!1,m=7,v=[.2,.3,.45,.6,.75,.85,.95,1,1.1,1.25,1.5,1.75,2,2.5,3,4,5],b=!1,D,F,C,S,N=["version","builds","changelogSeen"],$,R,x,Q;rc(()=>t(8,p=!0));function K(){D=setTimeout(()=>{t(9,b=!1)},750)}function W(){clearTimeout(D),t(9,b=!0),K()}let B=19814,te,Y,P=58,H=58,E=58,U;function M(){clearInterval(U),setTimeout(()=>{te=Date.now()/1e3/60/60/24,t(16,Y=Math.floor(te)-B),Jd(Xd(Qd(m_))).then(y=>{ue(lo,l=y.val().rngItemList[Y],l),t(26,C=y.val().rngItemList[Y-1])}),U=setInterval(()=>{let y=Date.now(),je=(B+Y+1)*24*60*60*1e3-y;t(17,P=Math.floor(je/1e3/60/60)),t(18,H=Math.floor(je%(1e3*60*60)/(1e3*60))),t(19,E=Math.floor(je%(1e3*60)/1e3)),P==0&&H==0&&E==0&&(ue(ot,o=Ua,o),M(),setTimeout(()=>location.reload(),1500))},1e3)},1e3)}M(),fetch("https://raw.githubusercontent.com/XT8SS/frontierdle/gh-pages/itemData.json").then(async y=>{if(y.status!=200){console.error(`Failed to fetch item data!
Status: ${y.status}`);return}let Se=await y.json();ue(ks,a=Se.sort((je,We)=>je.name.toLowerCase().localeCompare(We.name.toLowerCase())),a)});let de=[],ie=[],q,ne,le=9;for(let y=0;y<le;y++)de.push(`backgrounds/BG${y}.jpg`);function O(y){ne=Math.floor(Math.random()*y.length)}O(de);function J(){t(20,q=ne),ie.push(ne)}J(),function y(){setTimeout(()=>{if(O(de),!ie.length)J();else if(ie.length>3&&(ie=ie.slice(1)),!ie.includes(ne))J();else{let Se=[...Array(le).keys()].filter(je=>!ie.includes(je));O(Se),J()}document.visibilityState=="visible"&&y()},45e3)}(),localStorage.getItem("fd-version")!=Ns&&(ue(jn,c=!1,c),localStorage.setItem("fd-version",Ns));function j(){ue(ot,o.gameWin=!0,o),ue(ut,i.gamesPlayed++,i),ue(ut,i.gamesWon++,i),ue(ut,i.streak++,i),ue(ut,i.winInfo[o.chosenItems.length]++,i),(i.streak>=3?Q:R).play()}function ee(){ue(ot,o.gameOver=!0,o),ue(ut,i.gamesPlayed++,i),ue(ut,i.streak=0,i),x.play()}const ke=y=>{N.includes(y.key)?localStorage.setItem(y.key,y.oldValue):y.key=="fd-currentGameData"?y.url.includes("ls=true")?ue(ot,o=JSON.parse(y.newValue),o):localStorage.setItem("fd-currentGameData",JSON.stringify(o)):y.key=="fd-settings"?y.url.includes("ls=true")?ue(Tt,s=JSON.parse(y.newValue),s):localStorage.setItem("fd-settings",JSON.stringify(s)):y.key=="fd-playerStats"&&(y.url.includes("ls=true")?ue(ut,i=JSON.parse(y.newValue),i):localStorage.setItem("fd-playerStats",JSON.stringify(i)))},L=y=>{let Se=y.wheelDeltaY;if(y.ctrlKey){if(y.preventDefault(),v[m]==.2&&Se<0||v[m]==5&&Se>0)return;Se>0?t(2,m++,m):t(2,m--,m),W()}},ge=y=>{let Se=["Enter"," ","Escape"];y.ctrlKey&&(y.key=="-"||y.key=="+"||y.code=="Equal"||y.key=="0")&&(y.preventDefault(),(y.key=="+"||y.code=="Equal")&&v[m]!=5?t(2,m++,m):y.key=="-"&&v[m]!=.2?t(2,m--,m):y.key=="0"&&v[m]!=1&&t(2,m=7),W()),u.component&&$&&(!y.ctrlKey&&!y.shiftKey&&!y.altKey&&Se.includes(y.key)||y.key=="Tab")&&ue(qe,u.component=null,u)};function A(){t(0,h=window.outerHeight),t(1,d=window.outerWidth)}function ae(y){Ze[y?"unshift":"push"](()=>{R=y,t(13,R)})}function G(y){Ze[y?"unshift":"push"](()=>{x=y,t(14,x)})}function ve(y){Ze[y?"unshift":"push"](()=>{Q=y,t(15,Q)})}const gt=y=>{tn(y),ue(Tt,s.muted=!s.muted,s)},_e=y=>{tn(y),o.gameWin||o.gameOver?(location.hash="playerStats",Ts()):(ue(qe,u.complete=!0,u),ue(qe,u.component=$a,u))},bn=y=>{if(o.chosenItems.length){y.detail.checked=!y.detail.checked;return}ue(Tt,s.hardMode=y.detail.checked,s)};function ei(y){Y=y,t(16,Y)}function ti(y){Y=y,t(16,Y)}function qt(y){F=y,t(10,F),t(7,a),t(6,l),t(26,C)}function rt(y){Ze[y?"unshift":"push"](()=>{$=y,t(12,$)})}const Ue=y=>{$.children[0].contains(y.target)||(ue(qe,u.component=null,u),ue(qe,u.complete=!1,u))};function ni(y){Ze[y?"unshift":"push"](()=>{$=y,t(12,$)})}const Yt=y=>{$.children[0].contains(y.target)||(ue(qe,u.component=null,u),ue(qe,u.complete=!1,u))};return n.$$.update=()=>{if(n.$$.dirty[0]&7&&(h||d)){let y=d>h;document.documentElement.style.fontSize=`${(y?.75:d/h*.8)*v[m]}vh`}n.$$.dirty[0]&67109056&&a.length&&l&&(t(10,F=a.find(y=>y.name==l)),t(11,S=a.find(y=>y.name==C))),n.$$.dirty[0]&16&&ue(Di,r=s.hardMode?6:7,r),n.$$.dirty[0]&134217824&&o.chosenItems.length&&!o.gameWin&&!o.gameOver&&(o.chosenItems[o.chosenItems.length-1].name==l?j():o.chosenItems.length==r&&ee()),n.$$.dirty[0]&8&&i.streak>i.maxStreak&&ue(ut,i.maxStreak=i.streak,i)},[h,d,m,i,s,o,l,a,p,b,F,S,$,R,x,Q,Y,P,H,E,q,u,v,N,W,de,C,r,ke,L,ge,A,ae,G,ve,gt,_e,bn,ei,ti,qt,rt,Ue,ni,Yt]}class dp extends st{constructor(e){super(),it(this,e,fp,hp,Xe,{},null,[-1,-1,-1])}}new dp({target:document.body});
