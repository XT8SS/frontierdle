 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hh{constructor(e,t){this.appName_=e,this.appCheckProvider=t,this.appCheck=t==null?void 0:t.getImmediate({optional:!0}),this.appCheck||t==null||t.get().then(i=>this.appCheck=i)}getToken(e){return this.appCheck?this.appCheck.getToken(e):new Promise((t,i)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,i):t(null)},0)})}addTokenChangeListener(e){var t;(t=this.appCheckProvider)===null||t===void 0||t.get().then(i=>i.addTokenListener(e))}notifyForInvalidToken(){tt(`Provided AppCheck credentials for the app named "${this.appName_}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Hr;class Le{constructor(e,t=Le.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=t,this.lazyHash_=null,k(this.value_!==void 0&&this.value_!==null,"LeafNode shouldn't be created with null/undefined value."),ea(this.priorityNode_)}static set __childrenNodeConstructor(e){Hr=e}static get __childrenNodeConstructor(){return Hr}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new Le(this.value_,e)}getImmediateChild(e){return e===".priority"?this.priorityNode_:Le.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return oe(e)?this:ue(e)===".priority"?this.priorityNode_:Le.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,t){return null}updateImmediateChild(e,t){return e===".priority"?this.updatePriority(t):t.isEmpty()&&e!==".priority"?this:Le.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,t).updatePriority(this.priorityNode_)}updateChild(e,t){const i=ue(e);return i===null?t:t.isEmpty()&&i!==".priority"?this:(k(i!==".priority"||Pt(e)===1,".priority must be the last token in a path"),this.updateImmediateChild(i,Le.__childrenNodeConstructor.EMPTY_NODE.updateChild(Ie(e),t)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,t){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(this.lazyHash_===null){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+Zl(this.priorityNode_.val())+":");const t=typeof this.value_;e+=t+":",t==="number"?e+=Nl(this.value_):e+=this.value_,this.lazyHash_=Sl(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===Le.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof Le.__childrenNodeConstructor?-1:(k(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const t=typeof e.value_,i=typeof this.value_,s=Le.VALUE_TYPE_ORDER.indexOf(t),r=Le.VALUE_TYPE_ORDER.indexOf(i);return k(s>=0,"Unknown leaf type: "+t),k(r>=0,"Unknown leaf type: "+i),s===r?i==="object"?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:r-s}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const t=e;return this.value_===t.value_&&this.priorityNode_.equals(t.priorityNode_)}else return!1}}Le.VALUE_TYPE_ORDER=["object","boolean","number","string"];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hf{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&Je(this.last_,(i,s)=>{t[i]=t[i]-s}),this.last_=e,t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ci{constructor(e,t,i){this.path=e,this.affectedTree=t,this.revert=i,this.type=dt.ACK_USER_WRITE,this.source=ra()}operationForChild(e){if(oe(this.path)){if(this.affectedTree.value!=null)return k(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new be(e));return new Ci(fe(),t,this.revert)}}else return k(ue(this.path)===e,"operationForChild called for unrelated child."),new Ci(Ie(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Un{constructor(e,t,i){this.source=e,this.path=t,this.children=i,this.type=dt.MERGE}operationForChild(e){if(oe(this.path)){const t=this.children.subtree(new be(e));return t.isEmpty()?null:t.value?new Gt(this.source,fe(),t.value):new Un(this.source,fe(),t)}else return k(ue(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Un(this.source,Ie(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ts;const yf=()=>(ts||(ts=new Qe(ih)),ts);class Te{constructor(e,t=yf()){this.value=e,this.children=t}static fromObject(e){let t=new Te(null);return Je(e,(i,s)=>{t=t.set(new be(i),s)}),t}isEmpty(){return this.value===null&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(this.value!=null&&t(this.value))return{path:fe(),value:this.value};if(oe(e))return null;{const i=ue(e),s=this.children.get(i);if(s!==null){const r=s.findRootMostMatchingPathAndValue(Ie(e),t);return r!=null?{path:Oe(new be(i),r.path),value:r.value}:null}else return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,()=>!0)}subtree(e){if(oe(e))return this;{const t=ue(e),i=this.children.get(t);return i!==null?i.subtree(Ie(e)):new Te(null)}}set(e,t){if(oe(e))return new Te(t,this.children);{const i=ue(e),r=(this.children.get(i)||new Te(null)).set(Ie(e),t),o=this.children.insert(i,r);return new Te(this.value,o)}}remove(e){if(oe(e))return this.children.isEmpty()?new Te(null):new Te(null,this.children);{const t=ue(e),i=this.children.get(t);if(i){const s=i.remove(Ie(e));let r;return s.isEmpty()?r=this.children.remove(t):r=this.children.insert(t,s),this.value===null&&r.isEmpty()?new Te(null):new Te(this.value,r)}else return this}}get(e){if(oe(e))return this.value;{const t=ue(e),i=this.children.get(t);return i?i.get(Ie(e)):null}}setTree(e,t){if(oe(e))return t;{const i=ue(e),r=(this.children.get(i)||new Te(null)).setTree(Ie(e),t);let o;return r.isEmpty()?o=this.children.remove(i):o=this.children.insert(i,r),new Te(this.value,o)}}fold(e){return this.fold_(fe(),e)}fold_(e,t){const i={};return this.children.inorderTraversal((s,r)=>{i[s]=r.fold_(Oe(e,s),t)}),t(e,this.value,i)}findOnPath(e,t){return this.findOnPath_(e,fe(),t)}findOnPath_(e,t,i){const s=this.value?i(t,this.value):!1;if(s)return s;if(oe(e))return null;{const r=ue(e),o=this.children.get(r);return o?o.findOnPath_(Ie(e),Oe(t,r),i):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,fe(),t)}foreachOnPath_(e,t,i){if(oe(e))return this;{this.value&&i(t,this.value);const s=ue(e),r=this.children.get(s);return r?r.foreachOnPath_(Ie(e),Oe(t,s),i):new Te(null)}}foreach(e){this.foreach_(fe(),e)}foreach_(e,t){this.children.inorderTraversal((i,s)=>{s.foreach_(Oe(e,i),t)}),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal((t,i)=>{i.value&&e(t,i.value)})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
${location.origin+location.pathname}`),t(1,c=!0),setTimeout(()=>t(1,c=!1),1e3)};return n.$$set=h=>{"gameNumber"in h&&t(5,r=h.gameNumber)},[a,c,i,o,l,r,u]}class B_ extends rt{constructor(e){super(),st(this,e,W_,x_,Ze,{gameNumber:5})}}function No(n,e,t){const i=n.slice();return i[3]=e[t][0],i[4]=e[t][1],i[6]=t,i}function Ro(n){let e,t,i=n[3]+"",s,r,o,l,a,c=n[4]+"",u,h;return{c(){e=g("div"),t=g("span"),s=z(i),r=w(),o=g("span"),o.innerHTML="",l=w(),a=g("span"),u=z(c),h=w(),_(t,"id","guessNum"),_(t,"class","svelte-mzhi8s"),_(o,"class","posrel border-tp svelte-mzhi8s"),_(o,"id","winsBar"),un(o,"width",`${n[4]*80/n[2]}%`),_(a,"class","smaller-fs svelte-mzhi8s"),_(a,"id","winsNum"),_(e,"class","flex fai-center svelte-mzhi8s")},m(d,p){T(d,e,p),f(e,t),f(t,s),f(e,r),f(e,o),f(e,l),f(e,a),f(a,u),f(e,h)},p(d,p){p&2&&i!==(i=d[3]+"")&&pe(s,i),p&2&&un(o,"width",`${d[4]*80/d[2]}%`),p&2&&c!==(c=d[4]+"")&&pe(u,c)},d(d){d&&I(e)}}}function H_(n){let e,t,i,s,r,o,l,a=n[1].gamesPlayed+"",c,u,h,d,p,m,v=Math.floor(n[1].gamesWon*100/(n[1].gamesPlayed?n[1].gamesPlayed:1))+"",b,D,F,C,S,N,$,R=n[1].streak+"",x,Q,K,W,B,te,q=n[1].maxStreak+"",P,H,E,U,M,me,de,ie,Y,ne=ye(Object.entries(n[1].winInfo)),ae=[];for(let O=0;O<ne.length;O+=1)ae[O]=Ro(No(n,ne,O));return{c(){e=g("div"),t=g("span"),t.textContent="Your Stats",i=w(),s=g("div"),r=g("div"),o=g("div"),l=g("span"),c=z(a),u=w(),h=g("span"),h.textContent="Games Played",d=w(),p=g("div"),m=g("span"),b=z(v),D=z("%"),F=w(),C=g("span"),C.textContent="Win Rate",S=w(),N=g("div"),$=g("span"),x=z(R),Q=w(),K=g("span"),K.textContent="Current Streak",W=w(),B=g("div"),te=g("span"),P=z(q),H=w(),E=g("span"),E.textContent="Max Streak",U=w(),M=g("span"),M.textContent="Win Distribution",me=w(),de=g("div");for(let O=0;O<ae.length;O+=1)ae[O].c();_(h,"id","statsTitle"),_(h,"class","svelte-mzhi8s"),_(o,"class","svelte-mzhi8s"),_(C,"id","statsTitle"),_(C,"class","svelte-mzhi8s"),_(p,"class","svelte-mzhi8s"),_(K,"id","statsTitle"),_(K,"class","svelte-mzhi8s"),_(N,"class","svelte-mzhi8s"),_(E,"id","statsTitle"),_(E,"class","svelte-mzhi8s"),_(B,"class","svelte-mzhi8s"),_(r,"class","flex svelte-mzhi8s"),_(r,"id","playerStatsInfo"),_(M,"class","smaller-fs"),_(de,"class","flex fd-col smaller-fs svelte-mzhi8s"),_(de,"id","distributionChart"),_(e,"class","statsCont ff-bg flex fd-col fai-center border-tp br-1 bs"),_(e,"id","playerStats")},m(O,J){T(O,e,J),f(e,t),f(e,i),f(e,s),f(s,r),f(r,o),f(o,l),f(l,c),f(o,u),f(o,h),f(r,d),f(r,p),f(p,m),f(m,b),f(m,D),f(p,F),f(p,C),f(r,S),f(r,N),f(N,$),f($,x),f(N,Q),f(N,K),f(r,W),f(r,B),f(B,te),f(te,P),f(B,H),f(B,E),f(e,U),f(e,M),f(e,me),f(e,de);for(let j=0;j<ae.length;j+=1)ae[j]&&ae[j].m(de,null);Y=!0},p(O,[J]){if(n=O,(!Y||J&2)&&a!==(a=n[1].gamesPlayed+"")&&pe(c,a),(!Y||J&2)&&v!==(v=Math.floor(n[1].gamesWon*100/(n[1].gamesPlayed?n[1].gamesPlayed:1))+"")&&pe(b,v),(!Y||J&2)&&R!==(R=n[1].streak+"")&&pe(x,R),(!Y||J&2)&&q!==(q=n[1].maxStreak+"")&&pe(P,q),J&6){ne=ye(Object.entries(n[1].winInfo));let j;for(j=0;j<ne.length;j+=1){const ee=No(n,ne,j);ae[j]?ae[j].p(ee,J):(ae[j]=Ro(ee),ae[j].c(),ae[j].m(de,null))}for(;j<ae.length;j+=1)ae[j].d(1);ae.length=ne.length}},i(O){Y||(O&&Ae(()=>{Y&&(ie||(ie=we(e,Me,{duration:n[0]?200:0},!0)),ie.run(1))}),Y=!0)},o(O){O&&(ie||(ie=we(e,Me,{duration:n[0]?200:0},!1)),ie.run(0)),Y=!1},d(O){O&&I(e),Ke(ae,O),O&&ie&&ie.end()}}}function U_(n,e,t){let i;Ne(n,ut,o=>t(1,i=o));let{prompted:s=!1}=e,r=Math.max(...Object.values(i.winInfo));return n.$$set=o=>{"prompted"in o&&t(0,s=o.prompted)},[s,i,r]}class $a extends rt{constructor(e){super(),st(this,e,U_,H_,Ze,{prompted:0})}}function Do(n,e,t){const i=n.slice();return i[5]=e[t],i}function $_(n){let e,t=ye(n[1]),i=[];for(let s=0;s<t.length;s+=1)i[s]=Ao(Do(n,t,s));return{c(){for(let s=0;s<i.length;s+=1)i[s].c();e=kt()},m(s,r){for(let o=0;o<i.length;o+=1)i[o]&&i[o].m(s,r);T(s,e,r)},p(s,r){if(r&2){t=ye(s[1]);let o;for(o=0;o<t.length;o+=1){const l=Do(s,t,o);i[o]?i[o].p(l,r):(i[o]=Ao(l),i[o].c(),i[o].m(e.parentNode,e))}for(;o<i.length;o+=1)i[o].d(1);i.length=t.length}},d(s){s&&I(e),Ke(i,s)}}}function G_(n){let e,t,i;return{c(){e=g("span"),t=z("— "),i=z(n[1]),_(e,"id","info"),_(e,"class","svelte-hhfk27")},m(s,r){T(s,e,r),f(e,t),f(e,i)},p(s,r){r&2&&pe(i,s[1])},d(s){s&&I(e)}}}function Ao(n){let e,t,i=n[5]+"",s;return{c(){e=g("span"),t=z("— "),s=z(i),_(e,"id","info"),_(e,"class","svelte-hhfk27")},m(r,o){T(r,e,o),f(e,t),f(e,s)},p(r,o){o&2&&i!==(i=r[5]+"")&&pe(s,i)},d(r){r&&I(e)}}}function z_(n){let e,t,i,s,r,o,l;function a(h,d){return typeof h[1]=="string"?G_:$_}let c=a(n),u=c(n);return{c(){e=g("li"),t=g("span"),i=z("v"),s=z(n[0]),r=w(),o=g("i"),o.textContent=`${n[3][n[2][1]-1]+" "+n[2][0]+(Math.floor(n[2][0]/10)===1?"th":y_[n[2][0]%10])+", 20"+n[2][2]}`,l=w(),u.c(),_(t,"id","version"),_(t,"class","svelte-hhfk27"),_(o,"id","date"),_(o,"class","svelte-hhfk27"),_(e,"class","flex fai-center svelte-hhfk27")},m(h,d){T(h,e,d),f(e,t),f(t,i),f(t,s),f(e,r),f(e,o),f(e,l),u.m(e,null)},p(h,[d]){d&1&&pe(s,h[0]),c===(c=a(h))&&u?u.p(h,d):(u.d(1),u=c(h),u&&(u.c(),u.m(e,null)))},i:re,o:re,d(h){h&&I(e),u.d()}}}function j_(n,e,t){let{version:i,date:s,text:r}=e,o=s.split("/"),l=["January","February","March","April","May","June","July","August","Semptember","October","November","December"];return n.$$set=a=>{"version"in a&&t(0,i=a.version),"date"in a&&t(4,s=a.date),"text"in a&&t(1,r=a.text)},[i,r,o,l,s]}class V_ extends rt{constructor(e){super(),st(this,e,j_,z_,Ze,{version:0,date:4,text:1})}}function q_(n){let e,t,i,s,r;return s=new V_({props:{version:"1.0.0",date:"2/4/24",text:"v1 Release"}}),{c(){e=g("span"),e.textContent="Changelog",t=w(),i=g("ul"),ct(s.$$.fragment),_(e,"class","title"),_(i,"class","flex fd-col smaller-fs svelte-1hn7lke"),_(i,"id","contents")},m(o,l){T(o,e,l),T(o,t,l),T(o,i,l),nt(s,i,null),r=!0},p:re,i(o){r||(Z(s.$$.fragment,o),r=!0)},o(o){he(s.$$.fragment,o),r=!1},d(o){o&&(I(e),I(t),I(i)),it(s)}}}class Y_ extends rt{constructor(e){super(),st(this,e,null,q_,Ze,{})}}function K_(n){let e,t,i;return{c(){e=g("span"),e.textContent="Credits",t=w(),i=g("div"),i.innerHTML=`<p class="flex fai-center svelte-19w41p3">This is a personal project. Contact me directly on
        ...
        <a class="flex fjc-center fai-center cg-1 svelte-19w41p3" href="https://fantastic-frontier-roblox.fandom.com/wiki/Fantastic_Frontier_-_Roblox_Wiki" target="_blank"><iconify-icon id="fandom" icon="simple-icons:fandom" class="svelte-19w41p3"></iconify-icon>
            ...
            Nini, for the moral support (and anime isaac seen here)</span> <span>— All other daily games which Frontierdle was based on</span></p>`,_(e,"class","title"),_(i,"class","smaller-fs"),_(i,"id","contents")},m(s,r){T(s,e,r),T(s,t,r),T(s,i,r)},p:re,i:re,o:re,d(s){s&&(I(e),I(t),I(i))}}}class Q_ extends rt{constructor(e){super(),st(this,e,null,K_,Ze,{})}}function Po(n,e,t){const i=n.slice();return i[1]=e[t],i}function J_(n,e,t){const i=n.slice();return i[4]=e[t],i}function X_(n,e,t){const i=n.slice();return i[7]=e[t],i}function Oo(n,e,t){const i=n.slice();return i[10]=e[t],i}function Z_(n,e,t){const i=n.slice();return i[13]=e[t],i}function ep(n){let e;return{c(){e=g("li"),e.textContent=`— ${n[13].charAt(0).toUpperCase()+n[13].slice(1)} `},m(t,i){T(t,e,i)},p:re,d(t){t&&I(e)}}}function Mo(n){let e;return{c(){e=g("li"),e.textContent=`— ${n[10]} `},m(t,i){T(t,e,i)},p:re,d(t){t&&I(e)}}}function tp(n){let e;return{c(){e=g("li"),e.textContent=`— ${n[7]}`},m(t,i){T(t,e,i)},p:re,d(t){t&&I(e)}}}function np(n){let e;return{c(){e=g("li"),e.textContent=`— ${n[4]}`},m(t,i){T(t,e,i)},p:re,d(t){t&&I(e)}}}function Lo(n){let e;return{c(){e=g("li"),e.textContent=`— ${n[1]} Update`},m(t,i){T(t,e,i)},p:re,d(t){t&&I(e)}}}function ip(n){let e,t,i,s,r,o,l,a,c,u,h,d,p,m,v,b,D,F,C,S,N,$,R,x,Q,K,W,B,te,q,P,H,E,U,M,me,de=ye(p_),ie=[];for(let L=0;L<de.length;L+=1)ie[L]=ep(Z_(n,de,L));let Y=ye(Object.values(Ri)),ne=[];for(let L=0;L<Y.length;L+=1)ne[L]=Mo(Oo(n,Y,L));let ae=ye(["Black","Blue","Brown","Gray","Green","None","Orange","Pink","Purple","Red","White","Yellow"]),O=[];for(let L=0;L<12;L+=1)O[L]=tp(X_(n,ae,L));let J=ye(["Black","Blue","Green","Purple","Red","White","Yellow"]),j=[];for(let L=0;L<7;L+=1)j[L]=np(J_(n,J,L));let ee=ye(Object.values(Ni).slice(0,-1)),ke=[];for(let L=0;L<ee.length;L+=1)ke[L]=Lo(Po(n,ee,L));return{c(){e=g("span"),e.textContent="Help",t=w(),i=g("div"),s=g("p"),s.textContent=`Frontierdle works similarly to many other daily games. You have a\r
        ...
        Fantastic Frontier, which changes every day.`,r=w(),o=g("div"),o.innerHTML=`<span class="title">Color Guide</span> <div class="flex svelte-40lcrp" id="colorGuide"><span class="flex fjc-center fai-center ff-bg ff-item svelte-40lcrp" id="correct">Correct</span> <span class="flex fjc-center fai-center ff-bg ff-item posrel svelte-40lcrp" id="partial">Partial
            ...
            more expensive (up) or cheaper (down) than the guessed item.</span>`,l=w(),a=g("span"),a.textContent="Categories",c=w(),u=g("p"),h=g("span"),d=g("b"),d.textContent="Slot:",p=w(),m=g("ul");for(let L=0;L<ie.length;L+=1)ie[L].c();v=w(),b=g("span"),D=g("b"),D.textContent="Stats:",F=w(),C=g("ul");for(let L=0;L<ne.length;L+=1)ne[L].c();S=w(),N=g("span"),N.innerHTML=`<b>Avg. Cost:</b> <span>The average of all possible prices the item can be purchased at.
                ...
                the game&#39;s purposes.</span>`,$=w(),R=g("span"),x=g("b"),x.textContent="Colors:",Q=w(),K=g("ul");for(let L=0;L<12;L+=1)O[L].c();W=w(),B=g("span"),te=g("b"),te.textContent="Outline:",q=w(),P=g("ul");for(let L=0;L<7;L+=1)j[L].c();H=w(),E=g("span"),U=g("b"),U.textContent="Release:",M=w(),me=g("ul");for(let L=0;L<ke.length;L+=1)ke[L].c();_(e,"class","title"),_(o,"class","flex fd-col fai-center"),_(a,"class","title"),_(d,"class","svelte-40lcrp"),_(m,"class","svelte-40lcrp"),_(h,"class","flex fd-col list svelte-40lcrp"),_(D,"class","svelte-40lcrp"),_(C,"class","svelte-40lcrp"),_(b,"class","flex fd-col list svelte-40lcrp"),_(N,"class","flex fd-col limit-width svelte-40lcrp"),_(x,"class","svelte-40lcrp"),_(K,"class","svelte-40lcrp"),_(R,"class","flex fd-col list svelte-40lcrp"),_(te,"class","svelte-40lcrp"),_(P,"class","svelte-40lcrp"),_(B,"class","flex fd-col list svelte-40lcrp"),_(U,"class","svelte-40lcrp"),_(me,"class","svelte-40lcrp"),_(E,"class","flex fd-col list svelte-40lcrp"),_(u,"class","flex fjc-center smaller-fs svelte-40lcrp"),_(u,"id","categories"),_(i,"class","flex fd-col smaller-fs svelte-40lcrp"),_(i,"id","contents")},m(L,ge){T(L,e,ge),T(L,t,ge),T(L,i,ge),f(i,s),f(i,r),f(i,o),f(i,l),f(i,a),f(i,c),f(i,u),f(u,h),f(h,d),f(h,p),f(h,m);for(let A=0;A<ie.length;A+=1)ie[A]&&ie[A].m(m,null);f(u,v),f(u,b),f(b,D),f(b,F),f(b,C);for(let A=0;A<ne.length;A+=1)ne[A]&&ne[A].m(C,null);f(u,S),f(u,N),f(u,$),f(u,R),f(R,x),f(R,Q),f(R,K);for(let A=0;A<12;A+=1)O[A]&&O[A].m(K,null);f(u,W),f(u,B),f(B,te),f(B,q),f(B,P);for(let A=0;A<7;A+=1)j[A]&&j[A].m(P,null);f(u,H),f(u,E),f(E,U),f(E,M),f(E,me);for(let A=0;A<ke.length;A+=1)ke[A]&&ke[A].m(me,null)},p(L,[ge]){if(ge&0){Y=ye(Object.values(Ri));let A;for(A=0;A<Y.length;A+=1){const ce=Oo(L,Y,A);ne[A]?ne[A].p(ce,ge):(ne[A]=Mo(ce),ne[A].c(),ne[A].m(C,null))}for(;A<ne.length;A+=1)ne[A].d(1);ne.length=Y.length}if(ge&0){ee=ye(Object.values(Ni).slice(0,-1));let A;for(A=0;A<ee.length;A+=1){const ce=Po(L,ee,A);ke[A]?ke[A].p(ce,ge):(ke[A]=Lo(ce),ke[A].c(),ke[A].m(me,null))}for(;A<ke.length;A+=1)ke[A].d(1);ke.length=ee.length}},i:re,o:re,d(L){L&&(I(e),I(t),I(i)),Ke(ie,L),Ke(ne,L),Ke(O,L),Ke(j,L),Ke(ke,L)}}}function sp(n){return[]}class rp extends rt{constructor(e){super(),st(this,e,sp,ip,Ze,{})}}function op(n){let e,t,i;return{c(){e=g("span"),e.textContent="Frontierdle Policy",t=w(),i=g("div"),i.innerHTML=`<span class="subtitle">About</span> <p>This tool is a passion project, one that is independent and is not
        ...
        <img src="misc/kofi-badge.png" alt="" class="svelte-1aydprt"/></a>`,s=w(),r=g("button"),r.innerHTML='<iconify-icon icon="material-symbols:help-outline-rounded"></iconify-icon> <span class="tooltip" id="left">Help</span>',o=w(),l=g("button"),a=g("iconify-icon"),c=w(),u=g("span"),u.textContent="Changelog",h=w(),C&&C.c(),d=w(),p=g("button"),p.innerHTML='<iconify-icon icon="material-symbols:policy-outline-rounded"></iconify-icon> <span class="tooltip" id="left">Policy</span>',m=w(),v=g("span"),b=z(n[0]),_(e,"class","info p-1 svelte-1aydprt"),_(e,"id","credits"),_(i,"class","info p-1 svelte-1aydprt"),_(i,"id","donate"),_(r,"class","info p-1 svelte-1aydprt"),_(r,"id","help"),xe(a,"icon","octicon:log-16"),_(u,"class","tooltip"),_(u,"id","right"),_(l,"class","info svelte-1aydprt"),_(l,"id","changelog"),_(p,"class","info p-1 svelte-1aydprt"),_(p,"id","policy"),_(v,"class","info svelte-1aydprt"),_(v,"id","version")},m(S,N){T(S,e,N),T(S,t,N),T(S,i,N),T(S,s,N),T(S,r,N),T(S,o,N),T(S,l,N),f(l,a),f(l,c),f(l,u),f(l,h),C&&C.m(l,null),T(S,d,N),T(S,p,N),T(S,m,N),T(S,v,N),f(v,b),D||(F=[De(e,"click",n[3]),De(r,"click",n[4]),De(l,"click",n[5]),De(p,"click",n[6])],D=!0)},p(S,[N]){S[2]?C&&(lt(),he(C,1,1,()=>{C=null}),at()):C?N&4&&Z(C,1):(C=Fo(),C.c(),Z(C,1),C.m(l,null)),N&1&&pe(b,S[0])},i(S){Z(C)},o(S){he(C)},d(S){S&&(I(e),I(t),I(i),I(s),I(r),I(o),I(l),I(d),I(p),I(m),I(v)),C&&C.d(),D=!1,Xe(F)}}}function cp(n,e,t){let i,s;Ne(n,qe,u=>t(1,i=u)),Ne(n,jn,u=>t(2,s=u));let{version:r}=e;const o=u=>{tn(u),le(qe,i.component=Q_,i)},l=u=>{tn(u),le(qe,i.component=rp,i)},a=u=>{tn(u),le(qe,i.component=Y_,i),le(jn,s=!0,s)},c=u=>{tn(u),le(qe,i.component=lp,i)};return n.$$set=u=>{"version"in u&&t(0,r=u.version)},[r,i,s,o,l,a,c]}class up extends rt{constructor(e){super(),st(this,e,cp,ap,Ze,{version:0})}}const{document:oi}=Ya;function xo(n,e,t){const i=n.slice();return i[60]=e[t],i}function Wo(n,e,t){const i=n.slice();return i[60]=e[t],i}function Bo(n){let e;return{c(){e=g("link"),_(e,"rel","preload"),_(e,"as","image"),_(e,"href",n[60])},m(t,i){T(t,e,i)},p:re,d(t){t&&I(e)}}}function Ho(n){let e;return{c(){e=g("style"),e.textContent=`*:not(.promptCont, .promptCont *) {
            ...
            .info:not(#zoomLevel, #version) {
                ...
                pointer-events: none;
                    ...
                    <br/>
                    No stat / avg. cost / color clues</span>`,B=w(),te=g("span"),te.textContent="Nightmare Mode",q=w(),ct(P.$$.fragment),H=w(),j&&j.c(),E=w(),ee&&ee.c(),U=w(),ct(M.$$.fragment),de=w(),ge&&ge.c(),ie=w(),A&&A.c(),Y=w(),ce&&ce.c(),ne=kt(),xe(r,"icon",o="f7:speaker-"+(n[4].muted?"slash":"2")+"-fill"),xe(r,"class","svelte-247i5i"),_(a,"class","tooltip"),_(a,"id","bottom"),_(s,"class","flex light-hover svelte-247i5i"),_(i,"class","iconToggle ff-bg posrel border-tp br-1 bs svelte-247i5i"),Ge(p.src,m="frontierdle.svg")||_(p,"src",m),_(p,"alt","Frontierdle"),_(p,"class","svelte-247i5i"),S.a=null,_(b,"class","tooltip svelte-247i5i"),_(b,"id","bottom"),_(d,"class","iconCont ff-bg posrel border-tp br-1 bs no-bg-change svelte-247i5i"),_(x,"class","flex posrel light-hover svelte-247i5i"),_(R,"class","iconToggle ff-bg border-tp br-1 bs svelte-247i5i"),_(t,"class","upperMenu flex fai-center svelte-247i5i"),_(W,"class","flex posrel no-bg-change"),_(K,"class","hardModeCont ff-bg flex fai-center border-tp br-1 bs svelte-247i5i"),_(e,"class","flex fd-col fai-center posrel svelte-247i5i")},m(G,ve){T(G,e,ve),f(e,t),f(t,i),f(i,s),f(s,r),f(s,l),f(s,a),f(a,u),f(t,h),f(t,d),f(d,p),f(d,v),f(d,b),f(b,D),f(b,F),f(b,C),S.m(N,b),f(t,$),f(t,R),f(R,x),f(e,Q),f(e,K),f(K,W),f(K,B),f(K,te),f(K,q),nt(P,K,null),f(e,H),j&&j.m(e,null),f(e,E),ee&&ee.m(e,null),f(e,U),nt(M,e,null),f(e,de),ge&&ge.m(e,null),T(G,ie,ve),A&&A.m(G,ve),T(G,Y,ve),ce&&ce.m(G,ve),T(G,ne,ve),ae=!0,O||(J=[De(s,"click",n[35]),De(x,"click",n[36])],O=!0)},p(G,ve){(!ae||ve[0]&16&&o!==(o="f7:speaker-"+(G[4].muted?"slash":"2")+"-fill"))&&xe(r,"icon",o),(!ae||ve[0]&16)&&c!==(c=G[4].muted?"Muted":"Unmuted")&&pe(u,c),(!ae||ve[0]&917504)&&N!==(N=Ai(G[17],G[18],G[19])+"")&&S.p(N);const gt={};ve[0]&16&&(gt.checked=G[4].hardMode),ve[0]&32&&(gt.disabled=G[5].chosenItems.length!=0),P.$set(gt),!G[5].gameWin&&!G[5].gameOver?j?(j.p(G,ve),ve[0]&32&&Z(j,1)):(j=zo(G),j.c(),Z(j,1),j.m(e,E)):j&&(lt(),he(j,1,1,()=>{j=null}),at()),G[5].gameWin||G[5].gameOver?ee?(ee.p(G,ve),ve[0]&32&&Z(ee,1)):(ee=jo(G),ee.c(),Z(ee,1),ee.m(e,U)):ee&&(lt(),he(ee,1,1,()=>{ee=null}),at());const _e={};!me&&ve[0]&1024&&(me=!0,_e.dailyItemData=G[10],Oi(()=>me=!1)),M.$set(_e),G[11]?ge?ge.p(G,ve):(ge=Vo(G),ge.c(),ge.m(e,null)):ge&&(ge.d(1),ge=null),G[21].component&&G[21].complete?A?(A.p(G,ve),ve[0]&2097152&&Z(A,1)):(A=qo(G),A.c(),Z(A,1),A.m(Y.parentNode,Y)):A&&(lt(),he(A,1,1,()=>{A=null}),at()),G[21].component&&!G[21].complete?ce?(ce.p(G,ve),ve[0]&2097152&&Z(ce,1)):(ce=Yo(G),ce.c(),Z(ce,1),ce.m(ne.parentNode,ne)):ce&&(lt(),he(ce,1,1,()=>{ce=null}),at())},i(G){ae||(Z(P.$$.fragment,G),Z(j),Z(ee),Z(M.$$.fragment,G),Z(A),Z(ce),ae=!0)},o(G){he(P.$$.fragment,G),he(j),he(ee),he(M.$$.fragment,G),he(A),he(ce),ae=!1},d(G){G&&(I(e),I(ie),I(Y),I(ne)),it(P),j&&j.d(),ee&&ee.d(),it(M),ge&&ge.d(),A&&A.d(G),ce&&ce.d(G),O=!1,Xe(J)}}}function zo(n){let e,t,i;function s(o){n[38](o)}let r={};return n[16]!==void 0&&(r.gameNumber=n[16]),e=new F_({props:r}),et.push(()=>Mi(e,"gameNumber",s)),{c(){ct(e.$$.fragment)},m(o,l){nt(e,o,l),i=!0},p(o,l){const a={};!t&&l[0]&65536&&(t=!0,a.gameNumber=o[16],Oi(()=>t=!1)),e.$set(a)},i(o){i||(Z(e.$$.fragment,o),i=!0)},o(o){he(e.$$.fragment,o),i=!1},d(o){it(e,o)}}}function jo(n){let e,t,i=n[5].gameWin?"Fantastic!":"Farewell...",s,r,o,l,a,c=n[5].gameWin?"won":"lost",u,h,d,p,m,v,b,D,F,C,S,N,$,R,x=n[10].name+"",Q,K,W,B,te,q,P,H=Ai(n[17],n[18],n[19])+"",E,U,M,me,de,ie,Y;function ne(O){n[39](O)}let ae={};return n[16]!==void 0&&(ae.gameNumber=n[16]),M=new B_({props:ae}),et.push(()=>Mi(M,"gameNumber",ne)),ie=new $a({}),{c(){e=g("div"),t=g("span"),s=z(i),r=w(),o=g("img"),a=z(`
                    ...
                    `),te=g("br"),q=w(),P=g("span"),U=w(),ct(M.$$.fragment),de=w(),ct(ie.$$.fragment),Ge(o.src,l=n[5].gameWin?"ff-images/rb-fantastic.png":"ff-images/rb-farewell.png")||_(o,"src",l),_(o,"id","gameFinishIcon"),_(o,"alt",""),_(o,"class","svelte-247i5i"),_(t,"class","flex fai-center svelte-247i5i"),_(t,"id","gameFinishMessage"),_(p,"class","smaller-fs"),Ge(D.src,F=Lt+n[10].image)||_(D,"src",F),_(D,"alt",""),_(D,"class","svelte-247i5i"),xe(S,"icon","tabler:link"),xe(S,"class","svelte-247i5i"),_(b,"class","flex fjc-center fai-center svelte-247i5i"),_(b,"href",N=pn+n[10].link),_(b,"target","_blank"),_(v,"class","itemImg ff-item flex svelte-247i5i"),_(v,"id","dailyItemImg"),_(R,"class","ff-item itemName svelte-247i5i"),_(R,"id","dailyItemName"),_(P,"class","ff-item svelte-247i5i"),_(P,"id","nextItemTime"),_(W,"class","flex fd-col svelte-247i5i"),_(W,"id","nextItemCont"),_(e,"class","gameFinishCont ff-bg flex fd-col fai-center border-tp br-1 bs svelte-247i5i")},m(O,J){T(O,e,J),f(e,t),f(t,s),f(t,r),f(t,o),f(t,a),f(t,u),f(t,h),f(e,d),f(e,p),f(e,m),f(e,v),f(v,b),f(b,D),f(b,C),f(b,S),f(e,$),f(e,R),f(R,Q),f(e,K),f(e,W),f(W,B),f(W,te),f(W,q),f(W,P),P.innerHTML=H,T(O,U,J),nt(M,O,J),T(O,de,J),nt(ie,O,J),Y=!0},p(O,J){(!Y||J[0]&32)&&i!==(i=O[5].gameWin?"Fantastic!":"Farewell...")&&pe(s,i),(!Y||J[0]&32&&!Ge(o.src,l=O[5].gameWin?"ff-images/rb-fantastic.png":"ff-images/rb-farewell.png"))&&_(o,"src",l),(!Y||J[0]&32)&&c!==(c=O[5].gameWin?"won":"lost")&&pe(u,c),(!Y||J[0]&1024&&!Ge(D.src,F=Lt+O[10].image))&&_(D,"src",F),(!Y||J[0]&1024&&N!==(N=pn+O[10].link))&&_(b,"href",N),(!Y||J[0]&1024)&&x!==(x=O[10].name+"")&&pe(Q,x),(!Y||J[0]&917504)&&H!==(H=Ai(O[17],O[18],O[19])+"")&&(P.innerHTML=H);const j={};!me&&J[0]&65536&&(me=!0,j.gameNumber=O[16],Oi(()=>me=!1)),M.$set(j)},i(O){Y||(O&&Ae(()=>{Y&&(E||(E=we(e,bt,{duration:150},!0)),E.run(1))}),Z(M.$$.fragment,O),Z(ie.$$.fragment,O),Y=!0)},o(O){O&&(E||(E=we(e,bt,{duration:150},!1)),E.run(0)),he(M.$$.fragment,O),he(ie.$$.fragment,O),Y=!1},d(O){O&&(I(e),I(U),I(de)),O&&E&&E.end(),it(M,O),it(ie,O)}}}function Vo(n){let e,t,i,s,r,o,l,a,c,u,h,d=n[11].name+"",p;return{c(){e=g("div"),t=z(`Yesterday's item was...
                `),i=g("div"),s=g("a"),r=g("img"),l=w(),a=g("iconify-icon"),u=w(),h=g("span"),p=z(d),Ge(r.src,o=Lt+n[11].image)||_(r,"src",o),_(r,"alt",""),_(r,"class","svelte-247i5i"),xe(a,"icon","tabler:link"),xe(a,"class","svelte-247i5i"),_(s,"class","flex fjc-center fai-center svelte-247i5i"),_(s,"href",c=pn+n[11].link),_(s,"target","_blank"),_(i,"class","itemImg ff-item flex svelte-247i5i"),_(i,"id","previousItemImg"),_(h,"class","ff-item itemName svelte-247i5i"),_(h,"id","previousItemName"),_(e,"class","previousItemCont ff-bg flex fd-col fai-center border-tp br-1 bs svelte-247i5i")},m(m,v){T(m,e,v),f(e,t),f(e,i),f(i,s),f(s,r),f(s,l),f(s,a),f(e,u),f(e,h),f(h,p)},p(m,v){v[0]&2048&&!Ge(r.src,o=Lt+m[11].image)&&_(r,"src",o),v[0]&2048&&c!==(c=pn+m[11].link)&&_(s,"href",c),v[0]&2048&&d!==(d=m[11].name+"")&&pe(p,d)},d(m){m&&I(e)}}}function qo(n){let e,t,i,s,r;var o=n[21].component;function l(a,c){return{props:{prompted:!0}}}return o&&(t=ai(o,l())),{c(){e=g("div"),t&&ct(t.$$.fragment),_(e,"class","promptCont")},m(a,c){T(a,e,c),t&&nt(t,e,null),n[41](e),i=!0,s||(r=De(e,"click",n[42]),s=!0)},p(a,c){if(c[0]&2097152&&o!==(o=a[21].component)){if(t){lt();const u=t;he(u.$$.fragment,1,0,()=>{it(u,1)}),at()}o?(t=ai(o,l()),ct(t.$$.fragment),Z(t.$$.fragment,1),nt(t,e,null)):t=null}},i(a){i||(t&&Z(t.$$.fragment,a),i=!0)},o(a){t&&he(t.$$.fragment,a),i=!1},d(a){a&&I(e),t&&it(t),n[41](null),s=!1,r()}}}function Yo(n){let e,t,i,s,r,o,l;var a=n[21].component;function c(u,h){return{props:{prompted:!0}}}return a&&(i=ai(a,c())),{c(){e=g("div"),t=g("div"),i&&ct(i.$$.fragment),_(t,"class","flex fd-col border-tp br-1 bs"),_(e,"class","promptCont")},m(u,h){T(u,e,h),f(e,t),i&&nt(i,t,null),n[43](e),r=!0,o||(l=De(e,"click",n[44]),o=!0)},p(u,h){if(h[0]&2097152&&a!==(a=u[21].component)){if(i){lt();const d=i;he(d.$$.fragment,1,0,()=>{it(d,1)}),at()}a?(i=ai(a,c()),ct(i.$$.fragment),Z(i.$$.fragment,1),nt(i,t,null)):i=null}},i(u){r||(i&&Z(i.$$.fragment,u),u&&Ae(()=>{r&&(s||(s=we(t,Me,{duration:200},!0)),s.run(1))}),r=!0)},o(u){i&&he(i.$$.fragment,u),u&&(s||(s=we(t,Me,{duration:200},!1)),s.run(0)),r=!1},d(u){u&&I(e),i&&it(i),u&&s&&s.end(),n[43](null),o=!1,l()}}}function hp(n){let e,t,i,s,r,o,l,a,c,u,h,d,p,m,v,b,D,F,C,S,N,$,R,x,Q;Ae(n[31]);let K=ye(n[25]),W=[];for(let E=0;E<K.length;E+=1)W[E]=Bo(Wo(n,K,E));let B=n[21].component&&Ho(),te=ye(n[25]),q=[];for(let E=0;E<te.length;E+=1)q[E]=Uo(xo(n,te,E));let P=n[9]&&$o(n);S=new up({props:{version:Rs}});let H=n[7]&&n[6]&&n[8]&&Go(n);return{c(){for(let E=0;E<W.length;E+=1)W[E].c();e=kt(),B&&B.c(),t=kt(),i=w(),s=g("div"),r=g("audio"),a=w(),c=g("audio"),d=w(),p=g("audio"),b=w(),D=g("div");for(let E=0;E<q.length;E+=1)q[E].c();F=w(),P&&P.c(),C=w(),ct(S.$$.fragment),N=w(),H&&H.c(),$=kt(),Ge(r.src,o="audio/lucky.mp3")||_(r,"src",o),r.muted=l=n[4].muted,Ge(c.src,u="audio/farewell.mp3")||_(c,"src",u),c.muted=h=n[4].muted,Ge(p.src,m="audio/heDidItAgain.mp3")||_(p,"src",m),p.muted=v=n[4].muted,_(D,"class","backgrounds")},m(E,U){for(let M=0;M<W.length;M+=1)W[M]&&W[M].m(oi.head,null);f(oi.head,e),B&&B.m(oi.head,null),f(oi.head,t),T(E,i,U),T(E,s,U),f(s,r),n[32](r),f(s,a),f(s,c),n[33](c),f(s,d),f(s,p),n[34](p),T(E,b,U),T(E,D,U);for(let M=0;M<q.length;M+=1)q[M]&&q[M].m(D,null);T(E,F,U),P&&P.m(E,U),T(E,C,U),nt(S,E,U),T(E,N,U),H&&H.m(E,U),T(E,$,U),R=!0,x||(Q=[De(window,"storage",n[28]),De(window,"wheel",n[29],{passive:!1}),De(window,"keydown",n[30]),De(window,"resize",n[31])],x=!0)},p(E,U){if(U[0]&33554432){K=ye(E[25]);let M;for(M=0;M<K.length;M+=1){const me=Wo(E,K,M);W[M]?W[M].p(me,U):(W[M]=Bo(me),W[M].c(),W[M].m(e.parentNode,e))}for(;M<W.length;M+=1)W[M].d(1);W.length=K.length}if(E[21].component?B||(B=Ho(),B.c(),B.m(t.parentNode,t)):B&&(B.d(1),B=null),(!R||U[0]&16&&l!==(l=E[4].muted))&&(r.muted=l),(!R||U[0]&16&&h!==(h=E[4].muted))&&(c.muted=h),(!R||U[0]&16&&v!==(v=E[4].muted))&&(p.muted=v),U[0]&34603008){te=ye(E[25]);let M;for(M=0;M<te.length;M+=1){const me=xo(E,te,M);q[M]?q[M].p(me,U):(q[M]=Uo(me),q[M].c(),q[M].m(D,null))}for(;M<q.length;M+=1)q[M].d(1);q.length=te.length}E[9]?P?(P.p(E,U),U[0]&512&&Z(P,1)):(P=$o(E),P.c(),Z(P,1),P.m(C.parentNode,C)):P&&(lt(),he(P,1,1,()=>{P=null}),at()),E[7]&&E[6]&&E[8]?H?(H.p(E,U),U[0]&448&&Z(H,1)):(H=Go(E),H.c(),Z(H,1),H.m($.parentNode,$)):H&&(lt(),he(H,1,1,()=>{H=null}),at())},i(E){R||(Z(P),Z(S.$$.fragment,E),Z(H),R=!0)},o(E){he(P),he(S.$$.fragment,E),he(H),R=!1},d(E){E&&(I(i),I(s),I(b),I(D),I(F),I(C),I(N),I($)),Ke(W,E),I(e),B&&B.d(E),I(t),n[32](null),n[33](null),n[34](null),Ke(q,E),P&&P.d(E),it(S,E),H&&H.d(E),x=!1,Xe(Q)}}}let Rs="v1.0.0";function Ai(n,e,t){return`${(n<10?"0":"")+n}<b> : </b>${(e<10?"0":"")+e}<b> : </b>${(t<10?"0":"")+t}`}function fp(n,e,t){let i,s,r,o,l,a,c,u;Ne(n,ut,y=>t(3,i=y)),Ne(n,Tt,y=>t(4,s=y)),Ne(n,Di,y=>t(27,r=y)),Ne(n,Ye,y=>t(5,o=y)),Ne(n,ao,y=>t(6,l=y)),Ne(n,Ns,y=>t(7,a=y)),Ne(n,jn,y=>t(50,c=y)),Ne(n,qe,y=>t(21,u=y));let h,d,p=!1,m=7,v=[.2,.3,.45,.6,.75,.85,.95,1,1.1,1.25,1.5,1.75,2,2.5,3,4,5],b=!1,D,F,C,S,N=["version","builds","changelogSeen"],$,R,x,Q;rc(()=>t(8,p=!0));function K(){D=setTimeout(()=>{t(9,b=!1)},750)}function W(){clearTimeout(D),t(9,b=!0),K()}let B=19814,te,q,P=58,H=58,E=58,U;function M(){clearInterval(U),te=Date.now()/1e3/60/60/24,t(16,q=Math.floor(te)-B),o.gameNum!=q+1&&(le(Ye,o=Ts,o),le(Ye,o.gameNum=q+1,o)),Jd(Xd(Qd(m_))).then(y=>{le(ao,l=y.val().rngItemList[q],l),t(26,C=y.val().rngItemList[q-1])}),U=setInterval(()=>{let y=Date.now(),je=(B+q+1)*24*60*60*1e3-y;t(17,P=Math.floor(je/1e3/60/60)),t(18,H=Math.floor(je%(1e3*60*60)/(1e3*60))),t(19,E=Math.floor(je%(1e3*60)/1e3)),P==0&&H==0&&E==0&&(le(Ye,o=Ts,o),M(),setTimeout(()=>location.reload(),1500))},1e3)}M(),fetch("https://raw.githubusercontent.com/XT8SS/frontierdle/gh-pages/itemData.json").then(async y=>{if(y.status!=200){console.error(`Failed to fetch item data!
Status: ${y.status}`);return}let Se=await y.json();le(Ns,a=Se.sort((je,We)=>je.name.toLowerCase().localeCompare(We.name.toLowerCase())),a)});let de=[],ie=[],Y,ne,ae=9;for(let y=0;y<ae;y++)de.push(`backgrounds/BG${y}.jpg`);function O(y){ne=Math.floor(Math.random()*y.length)}O(de);function J(){t(20,Y=ne),ie.push(ne)}J(),function y(){setTimeout(()=>{if(O(de),!ie.length)J();else if(ie.length>3&&(ie=ie.slice(1)),!ie.includes(ne))J();else{let Se=[...Array(ae).keys()].filter(je=>!ie.includes(je));O(Se),J()}document.visibilityState=="visible"&&y()},45e3)}(),localStorage.getItem("fd-version")!=Rs&&(le(jn,c=!1,c),localStorage.setItem("fd-version",Rs));function j(){le(Ye,o.gameWin=!0,o),le(ut,i.gamesPlayed++,i),le(ut,i.gamesWon++,i),le(ut,i.streak++,i),le(ut,i.winInfo[o.chosenItems.length]++,i),(i.streak>=3?Q:R).play()}function ee(){le(Ye,o.gameOver=!0,o),le(ut,i.gamesPlayed++,i),le(ut,i.streak=0,i),x.play()}const ke=y=>{N.includes(y.key)?localStorage.setItem(y.key,y.oldValue):y.key=="fd-currentGameData"?y.url.includes("ls=true")?le(Ye,o=JSON.parse(y.newValue),o):localStorage.setItem("fd-currentGameData",JSON.stringify(o)):y.key=="fd-settings"?y.url.includes("ls=true")?le(Tt,s=JSON.parse(y.newValue),s):localStorage.setItem("fd-settings",JSON.stringify(s)):y.key=="fd-playerStats"&&(y.url.includes("ls=true")?le(ut,i=JSON.parse(y.newValue),i):localStorage.setItem("fd-playerStats",JSON.stringify(i)))},L=y=>{let Se=y.wheelDeltaY;if(y.ctrlKey){if(y.preventDefault(),v[m]==.2&&Se<0||v[m]==5&&Se>0)return;Se>0?t(2,m++,m):t(2,m--,m),W()}},ge=y=>{let Se=["Enter"," ","Escape"];y.ctrlKey&&(y.key=="-"||y.key=="+"||y.code=="Equal"||y.key=="0")&&(y.preventDefault(),(y.key=="+"||y.code=="Equal")&&v[m]!=5?t(2,m++,m):y.key=="-"&&v[m]!=.2?t(2,m--,m):y.key=="0"&&v[m]!=1&&t(2,m=7),W()),u.component&&$&&(!y.ctrlKey&&!y.shiftKey&&!y.altKey&&Se.includes(y.key)||y.key=="Tab")&&le(qe,u.component=null,u)};function A(){t(0,h=window.outerHeight),t(1,d=window.outerWidth)}function ce(y){et[y?"unshift":"push"](()=>{R=y,t(13,R)})}function G(y){et[y?"unshift":"push"](()=>{x=y,t(14,x)})}function ve(y){et[y?"unshift":"push"](()=>{Q=y,t(15,Q)})}const gt=y=>{tn(y),le(Tt,s.muted=!s.muted,s)},_e=y=>{tn(y),o.gameWin||o.gameOver?(location.hash="playerStats",ks()):(le(qe,u.complete=!0,u),le(qe,u.component=$a,u))},bn=y=>{if(o.chosenItems.length){y.detail.checked=!y.detail.checked;return}le(Tt,s.hardMode=y.detail.checked,s)};function ei(y){q=y,t(16,q)}function ti(y){q=y,t(16,q)}function qt(y){F=y,t(10,F),t(7,a),t(6,l),t(26,C)}function ot(y){et[y?"unshift":"push"](()=>{$=y,t(12,$)})}const Ue=y=>{$.children[0].contains(y.target)||(le(qe,u.component=null,u),le(qe,u.complete=!1,u))};function ni(y){et[y?"unshift":"push"](()=>{$=y,t(12,$)})}const Yt=y=>{$.children[0].contains(y.target)||(le(qe,u.component=null,u),le(qe,u.complete=!1,u))};return n.$$.update=()=>{if(n.$$.dirty[0]&7&&(h||d)){let y=d>h;document.documentElement.style.fontSize=`${(y?.75:d/h*.8)*v[m]}vh`}n.$$.dirty[0]&67109056&&a.length&&l&&(t(10,F=a.find(y=>y.name==l)),t(11,S=a.find(y=>y.name==C))),n.$$.dirty[0]&16&&le(Di,r=s.hardMode?6:7,r),n.$$.dirty[0]&134217824&&o.chosenItems.length&&!o.gameWin&&!o.gameOver&&(o.chosenItems[o.chosenItems.length-1].name==l?j():o.chosenItems.length==r&&ee()),n.$$.dirty[0]&8&&i.streak>i.maxStreak&&le(ut,i.maxStreak=i.streak,i)},[h,d,m,i,s,o,l,a,p,b,F,S,$,R,x,Q,q,P,H,E,Y,u,v,N,W,de,C,r,ke,L,ge,A,ce,G,ve,gt,_e,bn,ei,ti,qt,ot,Ue,ni,Yt]}class dp extends rt{constructor(e){super(),st(this,e,fp,hp,Ze,{},null,[-1,-1,-1])}}new dp({target:document.body});
