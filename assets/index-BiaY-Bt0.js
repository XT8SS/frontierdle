 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Es=new Map,Ei=new Map;function eh(n,e){try{n.container.addComponent(e)}catch(t){Zt.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function Is(n){const e=n.name;if(Ei.has(e))return Zt.debug(`There were multiple attempts to register component ${e}.`),!1;Ei.set(e,n);for(const t of Es.values())eh(t,n);return!0}function th(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nh={"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."},jt=new Ml("app","Firebase",nh);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ih=Xu;function ql(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const s=Object.assign({name:Ci,automaticDataCollectionEnabled:!1},e),i=s.name;if(typeof i!="string"||!i)throw jt.create("bad-app-name",{appName:String(i)});if(t||(t=Al()),!t)throw jt.create("no-options");const r=Es.get(i);if(r){if(vi(t,r.options)&&vi(s,r.config))return r;throw jt.create("duplicate-app",{appName:i})}const o=new uu(i);for(const a of Ei.values())o.addComponent(a);const l=new sh(t,s,o);return Es.set(i,l),l}function rh(n=Ci){const e=Es.get(n);if(!e&&n===Ci&&Al())return ql();if(!e)throw jt.create("no-app",{appName:n});return e}function gn(n,e,t){var s;let i=(s=Zu[n])!==null&&s!==void 0?s:n;t&&(i+=`-${t}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const l=[`Unable to register library "${i}" with version "${e}":`];r&&l.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Zt.warn(l.join(" "));return}Is(new $n(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oh="firebase-heartbeat-database",lh=1,Yn="firebase-heartbeat-store";let oi=null;function jl(){return oi||(oi=Eu(oh,lh,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Yn)}catch(t){console.warn(t)}}}}).catch(n=>{throw jt.create("idb-open",{originalErrorMessage:n.message})})),oi}async function ah(n){try{const t=(await jl()).transaction(Yn),s=await t.objectStore(Yn).get(Hl(n));return await t.done,s}catch(e){if(e instanceof is)Zt.warn(e.message);else{const t=jt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Zt.warn(t.message)}}}async function Pr(n,e){try{const s=(await jl()).transaction(Yn,"readwrite");await s.objectStore(Yn).put(e,Hl(n)),await s.done}catch(t){if(t instanceof is)Zt.warn(t.message);else{const s=jt.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});Zt.warn(s.message)}}}function Hl(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _h(n){Is(new $n("platform-logger",e=>new Tu(e),"PRIVATE")),Is(new $n("heartbeat",e=>new hh(e),"PRIVATE")),gn(wi,Ar,n),gn(wi,Ar,"esm2017"),gn("fire-js","")}_h("");var ph="firebase",mh="10.9.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */gn(ph,mh,"app");var Lr={};const Fr="@firebase/database",xr="1.0.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gl=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new vh(e)}}catch{}return new yh},Jt=Gl("localStorage"),Ii=Gl("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ia{constructor(e,t,s,i,r=!1,o="",l=!1,a=!1){this.secure=t,this.namespace=s,this.webSocketOnly=i,this.nodeAdmin=r,this.persistenceKey=o,this.includeNamespaceInQueryParams=l,this.isUsingEmulator=a,this._host=e.toLowerCase(),this._domain=this._host.substr(this._host.indexOf(".")+1),this.internalHost=Jt.get("host:"+e)||this._host}isCacheableHost(){return this.internalHost.substr(0,2)==="s-"}isCustomHost(){return this._domain!=="firebaseio.com"&&this._domain!=="firebaseio-demo.com"}get host(){return this._host}set host(e){e!==this.internalHost&&(this.internalHost=e,this.isCacheableHost()&&Jt.set("host:"+this._host,this.internalHost))}toString(){let e=this.toURLString();return this.persistenceKey&&(e+="<"+this.persistenceKey+">"),e}toURLString(){const e=this.secure?"https://":"http://",t=this.includeNamespaceInQueryParams?`?ns=${this.namespace}`:"";return`${e}${this.host}/${t}`}}function Mh(n){return n.host!==n.internalHost||n.isCustomHost()||n.includeNamespaceInQueryParams}function ra(n,e,t){A(typeof e=="string","typeof type must == string"),A(typeof t=="object","typeof params must == object");let s;if(e===na)s=(n.secure?"wss://":"ws://")+n.internalHost+"/.ws?";else if(e===sa)s=(n.secure?"https://":"http://")+n.internalHost+"/.lp?";else throw new Error("Unknown connection type: "+e);Mh(n)&&(t.ns=n.namespace);const i=[];return ft(t,(r,o)=>{i.push(r+"="+o)}),s+i.join("&")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vs{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const s=new re(En,e),i=new re(En,t);return this.compare(s,i)!==0}minPost(){return re.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ki;function mf(n){ki=n}const ya=function(n){return typeof n=="number"?"number:"+Yl(n):"string:"+n},ba=function(n){if(n.isLeafNode()){const e=n.val();A(typeof e=="string"||typeof e=="number"||typeof e=="object"&&Ft(e,".sv"),"Priority must be a string or number.")}else A(n===ki||n.isEmpty(),"priority of unexpected type.");A(n===ki||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ui;const un={};class Dt{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return A(un&&Fe,"ChildrenNode.ts has not been loaded"),ui=ui||new Dt({".priority":un},{".priority":Fe}),ui}get(e){const t=Cn(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof ut?t:null}hasIndex(e){return Ft(this.indexSet_,e.toString())}addIndex(e,t){A(e!==bn,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let i=!1;const r=t.getIterator(re.Wrap);let o=r.getNext();for(;o;)i=i||e.isDefinedOn(o.node),s.push(o),o=r.getNext();let l;i?l=ks(s,e.getCompare()):l=un;const a=e.toString(),c=Object.assign({},this.indexSet_);c[a]=e;const u=Object.assign({},this.indexes_);return u[a]=l,new Dt(u,c)}addToIndexes(e,t){const s=Cs(this.indexes_,(i,r)=>{const o=Cn(this.indexSet_,r);if(A(o,"Missing index implementation for "+r),i===un)if(o.isDefinedOn(e.node)){const l=[],a=t.getIterator(re.Wrap);let c=a.getNext();for(;c;)c.name!==e.name&&l.push(c),c=a.getNext();return l.push(e),ks(l,o.getCompare())}else return un;else{const l=t.get(e.name);let a=i;return l&&(a=a.remove(new re(e.name,l))),a.insert(e,e.node)}});return new Dt(s,this.indexSet_)}removeFromIndexes(e,t){const s=Cs(this.indexes_,i=>{if(i===un)return i;{const r=t.get(e.name);return r?i.remove(new re(e.name,r)):i}});return new Dt(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ea(n){return{type:"value",snapshotNode:n}}function In(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function Qn(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function Jn(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function kf(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class er{constructor(e){this.index_=e}updateChild(e,t,s,i,r,o){A(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const l=e.getImmediateChild(t);return l.getChild(i).equals(s.getChild(i))&&l.isEmpty()===s.isEmpty()||(o!=null&&(s.isEmpty()?e.hasChild(t)?o.trackChildChange(Qn(t,l)):A(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):l.isEmpty()?o.trackChildChange(In(t,s)):o.trackChildChange(Jn(t,s,l))),e.isLeafNode()&&s.isEmpty())?e:e.updateImmediateChild(t,s).withIndex(this.index_)}updateFullNode(e,t,s){return s!=null&&(e.isLeafNode()||e.forEachChild(Fe,(i,r)=>{t.hasChild(i)||s.trackChildChange(Qn(i,r))}),t.isLeafNode()||t.forEachChild(Fe,(i,r)=>{if(e.hasChild(i)){const o=e.getImmediateChild(i);o.equals(r)||s.trackChildChange(Jn(i,r,o))}else s.trackChildChange(In(i,r))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?K.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const eo=10*1e3,Of=30*1e3,Mf=5*60*1e3;class Lf{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Pf(e);const s=eo+(Of-eo)*Math.random();qn(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),t={};let s=!1;ft(e,(i,r)=>{r>0&&Ft(this.statsToReport_,i)&&(t[i]=r,s=!0)}),s&&this.server_.reportStats(t),qn(this.reportStats_.bind(this),Math.floor(Math.random()*2*Mf))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tn{constructor(e,t,s){this.source=e,this.path=t,this.snap=s,this.type=St.OVERWRITE}operationForChild(e){return ce(this.path)?new tn(this.source,be(),this.snap.getImmediateChild(e)):new tn(this.source,Ae(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class es{constructor(e,t,s){this.source=e,this.path=t,this.children=s,this.type=St.MERGE}operationForChild(e){if(ce(this.path)){const t=this.children.subtree(new Ne(e));return t.isEmpty()?null:t.value?new tn(this.source,be(),t.value):new es(this.source,be(),t)}else return A(_e(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new es(this.source,Ae(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $s(n,e){return{eventCache:n,serverCache:e}}function jn(n,e,t,s){return $s(new zt(e,t,s),n.serverCache)}function Ta(n,e,t,s){return $s(n.eventCache,new zt(e,t,s))}function As(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function nn(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class td{getCompleteChild(e){return null}getChildAfterChild(e,t,s){return null}}const Pa=new td;class or{constructor(e,t,s=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=s}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const s=this.optCompleteServerCache_!=null?new zt(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return rr(this.writes_,e,s)}}getChildAfterChild(e,t,s){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:nn(this.viewCache_),r=Zf(this.writes_,i,t,1,s,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ls;class La{constructor(){this.views=new Map}}function md(n){A(!Ls,"__referenceConstructor has already been defined"),Ls=n}function gd(){return A(Ls,"Reference.ts has not been loaded"),Ls}function vd(n){return n.views.size===0}function lr(n,e,t,s){const i=e.source.queryId;if(i!==null){const r=n.views.get(i);return A(r!=null,"SyncTree gave us an op for an invalid query."),co(r,e,t,s)}else{let r=[];for(const o of n.views.values())r=r.concat(co(o,e,t,s));return r}}function Fa(n,e,t,s,i){const r=e._queryIdentifier,o=n.views.get(r);if(!o){let l=Ps(t,i?s:null),a=!1;l?a=!0:s instanceof K?(l=ir(t,s),a=!1):(l=K.EMPTY_NODE,a=!1);const c=$s(new zt(l,a,!1),new zt(s,i,!1));return new ud(e,c)}return o}function yd(n,e,t,s,i,r){const o=Fa(n,e,s,i,r);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,o),_d(o,t),pd(o,t)}function bd(n,e,t,s){const i=e._queryIdentifier,r=[];let o=[];const l=Vt(n);if(i==="default")for(const[a,c]of n.views.entries())o=o.concat(ao(c,t,s)),lo(c)&&(n.views.delete(a),c.query._queryParams.loadsAllData()||r.push(c.query));else{const a=n.views.get(i);a&&(o=o.concat(ao(a,t,s)),lo(a)&&(n.views.delete(i),a.query._queryParams.loadsAllData()||r.push(a.query)))}return l&&!Vt(n)&&r.push(new(gd())(e._repo,e._path)),{removed:r,events:o}}function xa(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function Ut(n,e){let t=null;for(const s of n.views.values())t=t||dd(s,e);return t}function Wa(n,e){if(e._queryParams.loadsAllData())return Ks(n);{const s=e._queryIdentifier;return n.views.get(s)}}function Ba(n,e){return Wa(n,e)!=null}function Vt(n){return Ks(n)!=null}function Ks(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Fs;function wd(n){A(!Fs,"__referenceConstructor has already been defined"),Fs=n}function Cd(){return A(Fs,"Reference.ts has not been loaded"),Fs}let Ed=1;class uo{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Pe(null),this.pendingWriteTree_=Xf(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Id(n,e,t,s,i){return jf(n.pendingWriteTree_,e,t,s,i),i?us(n,new tn(Sa(),e,t)):[]}function dn(n,e,t=!1){const s=Hf(n.pendingWriteTree_,e);if(Uf(n.pendingWriteTree_,e)){let r=new Pe(null);return s.snap!=null?r=r.set(be(),!0):ft(s.children,o=>{r=r.set(new Ne(o),!0)}),us(n,new Ds(s.path,r,t))}else return[]}function cs(n,e,t){return us(n,new tn(nr(),e,t))}function Sd(n,e,t){const s=Pe.fromObject(t);return us(n,new es(nr(),e,s))}function Td(n,e){return us(n,new Zn(nr(),e))}function kd(n,e,t){const s=ar(n,t);if(s){const i=cr(s),r=i.path,o=i.queryId,l=nt(r,e),a=new Zn(sr(o),l);return ur(n,r,a)}else return[]}function qa(n,e,t,s,i=!1){const r=e._path,o=n.syncPointTree_.get(r);let l=[];if(o&&(e._queryIdentifier==="default"||Ba(o,e))){const a=bd(o,e,t,s);vd(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const c=a.removed;if(l=a.events,!i){const u=c.findIndex(d=>d._queryParams.loadsAllData())!==-1,f=n.syncPointTree_.findOnPath(r,(d,p)=>Vt(p));if(u&&!f){const d=n.syncPointTree_.subtree(r);if(!d.isEmpty()){const p=Ad(d);for(let g=0;g<p.length;++g){const v=p[g],E=v.query,T=za(n,v);n.listenProvider_.startListening(Un(E),ts(n,E),T.hashFn,T.onComplete)}}}!f&&c.length>0&&!s&&(u?n.listenProvider_.stopListening(Un(e),null):c.forEach(d=>{const p=n.queryToTagMap.get(Qs(d));n.listenProvider_.stopListening(Un(d),p)}))}Pd(n,c)}return l}function ja(n,e,t,s){const i=ar(n,s);if(i!=null){const r=cr(i),o=r.path,l=r.queryId,a=nt(o,e),c=new tn(sr(l),a,t);return ur(n,o,c)}else return[]}function Nd(n,e,t,s){const i=ar(n,s);if(i){const r=cr(i),o=r.path,l=r.queryId,a=nt(o,e),c=Pe.fromObject(t),u=new es(sr(l),a,c);return ur(n,o,u)}else return[]}function Rd(n,e,t,s=!1){const i=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(i,(d,p)=>{const g=nt(d,i);r=r||Ut(p,g),o=o||Vt(p)});let l=n.syncPointTree_.get(i);l?(o=o||Vt(l),r=r||Ut(l,be())):(l=new La,n.syncPointTree_=n.syncPointTree_.set(i,l));let a;r!=null?a=!0:(a=!1,r=K.EMPTY_NODE,n.syncPointTree_.subtree(i).foreachChild((p,g)=>{const v=Ut(g,be());v&&(r=r.updateImmediateChild(p,v))}));const c=Ba(l,e);if(!c&&!e._queryParams.loadsAllData()){const d=Qs(e);A(!n.queryToTagMap.has(d),"View does not exist, but we have a tag");const p=Od();n.queryToTagMap.set(d,p),n.tagToQueryMap.set(p,d)}const u=Ys(n.pendingWriteTree_,i);let f=yd(l,e,t,u,r,a);if(!c&&!o&&!s){const d=Wa(l,e);f=f.concat(Md(n,e,d))}return f}function Ha(n,e,t){const i=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,l)=>{const a=nt(o,e),c=Ut(l,a);if(c)return c});return Ra(i,e,r,t,!0)}function Dd(n,e){const t=e._path;let s=null;n.syncPointTree_.foreachOnPath(t,(c,u)=>{const f=nt(c,t);s=s||Ut(u,f)});let i=n.syncPointTree_.get(t);i?s=s||Ut(i,be()):(i=new La,n.syncPointTree_=n.syncPointTree_.set(t,i));const r=s!=null,o=r?new zt(s,!0,!1):null,l=Ys(n.pendingWriteTree_,e._path),a=Fa(i,e,l,r?o.getNode():K.EMPTY_NODE,r);return fd(a)}function us(n,e){return Ua(e,n.syncPointTree_,null,Ys(n.pendingWriteTree_,be()))}function Ua(n,e,t,s){if(ce(n.path))return Ga(n,e,t,s);{const i=e.get(be());t==null&&i!=null&&(t=Ut(i,be()));let r=[];const o=_e(n.path),l=n.operationForChild(o),a=e.children.get(o);if(a&&l){const c=t?t.getImmediateChild(o):null,u=Da(s,o);r=r.concat(Ua(l,a,c,u))}return i&&(r=r.concat(lr(i,n,s,t))),r}}function Ga(n,e,t,s){const i=e.get(be());t==null&&i!=null&&(t=Ut(i,be()));let r=[];return e.children.inorderTraversal((o,l)=>{const a=t?t.getImmediateChild(o):null,c=Da(s,o),u=n.operationForChild(o);u&&(r=r.concat(Ga(u,l,a,c)))}),i&&(r=r.concat(lr(i,n,s,t))),r}function za(n,e){const t=e.query,s=ts(n,t);return{hashFn:()=>(hd(e)||K.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return s?kd(n,t._path,s):Td(n,t._path);{const r=kh(i,t);return qa(n,t,null,r)}}}}function ts(n,e){const t=Qs(e);return n.queryToTagMap.get(t)}function Qs(n){return n._path.toString()+"$"+n._queryIdentifier}function ar(n,e){return n.tagToQueryMap.get(e)}function cr(n){const e=n.indexOf("$");return A(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new Ne(n.substr(0,e))}}function ur(n,e,t){const s=n.syncPointTree_.get(e);A(s,"Missing sync point for query tag that we're tracking");const i=Ys(n.pendingWriteTree_,e);return lr(s,t,i,null)}function Ad(n){return n.fold((e,t,s)=>{if(t&&Vt(t))return[Ks(t)];{let i=[];return t&&(i=xa(t)),ft(s,(r,o)=>{i=i.concat(o)}),i}})}function Un(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(Cd())(n._repo,n._path):n}function Pd(n,e){for(let t=0;t<e.length;++t){const s=e[t];if(!s._queryParams.loadsAllData()){const i=Qs(s),r=n.queryToTagMap.get(i);n.queryToTagMap.delete(i),n.tagToQueryMap.delete(r)}}}function Od(){return Ed++}function Md(n,e,t){const s=e._path,i=ts(n,e),r=za(n,t),o=n.listenProvider_.startListening(Un(e),i,r.hashFn,r.onComplete),l=n.syncPointTree_.subtree(s);if(i)A(!Vt(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((c,u,f)=>{if(!ce(c)&&u&&Vt(u))return[Ks(u).query];{let d=[];return u&&(d=d.concat(xa(u).map(p=>p.query))),ft(f,(p,g)=>{d=d.concat(g)}),d}});for(let c=0;c<a.length;++c){const u=a[c];n.listenProvider_.stopListening(Un(u),ts(n,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ud=/[\[\].#$\/\u0000-\u001F\u007F]/,Gd=/[\[\].#$\u0000-\u001F\u007F]/,fi=10*1024*1024,Ka=function(n){return typeof n=="string"&&n.length!==0&&!Ud.test(n)},Qa=function(n){return typeof n=="string"&&n.length!==0&&!Gd.test(n)},zd=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),Qa(n)},Ja=function(n,e,t){const s=t instanceof Ne?new lf(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+Qt(s));if(typeof e=="function")throw new Error(n+"contains a function "+Qt(s)+" with contents = "+e.toString());if(Vl(e))throw new Error(n+"contains "+e.toString()+" "+Qt(s));if(typeof e=="string"&&e.length>fi/3&&zs(e)>fi)throw new Error(n+"contains a string greater than "+fi+" utf8 bytes "+Qt(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,r=!1;if(ft(e,(o,l)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!Ka(o)))throw new Error(n+" contains an invalid key ("+o+") "+Qt(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);af(s,o),Ja(n,l,s),cf(s)}),i&&r)throw new Error(n+' contains ".value" child '+Qt(s)+" in addition to actual children.")}},Xa=function(n,e,t,s){if(!(s&&t===void 0)&&!Qa(t))throw new Error(Fl(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},Vd=function(n,e,t,s){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),Xa(n,e,t,s)},$d=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Ka(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!zd(t))throw new Error(Fl(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yd{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Kd(n,e){let t=null;for(let s=0;s<e.length;s++){const i=e[s],r=i.getPath();t!==null&&!ma(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(i)}t&&n.eventLists_.push(t)}function Yt(n,e,t){Kd(n,t),Qd(n,s=>It(s,e)||It(e,s))}function Qd(n,e){n.recursionDepth_++;let t=!0;for(let s=0;s<n.eventLists_.length;s++){const i=n.eventLists_[s];if(i){const r=i.path;e(r)?(Jd(n.eventLists_[s]),n.eventLists_[s]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function Jd(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const s=t.getEventRunner();Xt&&Ze("event: "+t.toString()),ls(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xd="repo_interrupt",Zd=25;class e_{constructor(e,t,s,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=s,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Yd,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Rs(),this.transactionQueueTree_=new _r,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function t_(n,e,t){if(n.stats_=Qi(n.repoInfo_),n.forceRestClient_||Ah())n.server_=new Ns(n.repoInfo_,(s,i,r,o)=>{fo(n,s,i,r,o)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>_o(n,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{je(t)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}n.persistentConnection_=new Ot(n.repoInfo_,e,(s,i,r,o)=>{fo(n,s,i,r,o)},s=>{_o(n,s)},s=>{s_(n,s)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(s=>{n.server_.refreshAuthToken(s)}),n.appCheckProvider_.addTokenChangeListener(s=>{n.server_.refreshAppCheckToken(s.token)}),n.statsReporter_=Fh(n.repoInfo_,()=>new Lf(n.stats_,n.server_)),n.infoData_=new Df,n.infoSyncTree_=new uo({startListening:(s,i,r,o)=>{let l=[];const a=n.infoData_.getNode(s._path);return a.isEmpty()||(l=cs(n.infoSyncTree_,s._path,a),setTimeout(()=>{o("ok")},0)),l},stopListening:()=>{}}),mr(n,"connected",!1),n.serverSyncTree_=new uo({startListening:(s,i,r,o)=>(n.server_.listen(s,r,i,(l,a)=>{const c=o(l,a);Yt(n.eventQueue_,s._path,c)}),[]),stopListening:(s,i)=>{n.server_.unlisten(s,i)}})}function n_(n){const t=n.infoData_.getNode(new Ne(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function Za(n){return Ld({timestamp:n_(n)})}function fo(n,e,t,s,i){n.dataUpdateCount++;const r=new Ne(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let o=[];if(i)if(s){const a=Cs(t,c=>Qe(c));o=Nd(n.serverSyncTree_,r,a,i)}else{const a=Qe(t);o=ja(n.serverSyncTree_,r,a,i)}else if(s){const a=Cs(t,c=>Qe(c));o=Sd(n.serverSyncTree_,r,a)}else{const a=Qe(t);o=cs(n.serverSyncTree_,r,a)}let l=r;o.length>0&&(l=yr(n,r)),Yt(n.eventQueue_,l,o)}function _o(n,e){mr(n,"connected",e),e===!1&&o_(n)}function s_(n,e){ft(e,(t,s)=>{mr(n,t,s)})}function mr(n,e,t){const s=new Ne("/.info/"+e),i=Qe(t);n.infoData_.updateSnapshot(s,i);const r=cs(n.infoSyncTree_,s,i);Yt(n.eventQueue_,s,r)}function i_(n){return n.nextWriteId_++}function r_(n,e,t){const s=Dd(n.serverSyncTree_,e);return s!=null?Promise.resolve(s):n.server_.get(e).then(i=>{const r=Qe(i).withIndex(e._queryParams.getIndex());Rd(n.serverSyncTree_,e,t,!0);let o;if(e._queryParams.loadsAllData())o=cs(n.serverSyncTree_,e._path,r);else{const l=ts(n.serverSyncTree_,e);o=ja(n.serverSyncTree_,e._path,r,l)}return Yt(n.eventQueue_,e._path,o),qa(n.serverSyncTree_,e,t,null,!0),r},i=>(gr(n,"get for query "+je(e)+" failed: "+i),Promise.reject(new Error(i))))}function o_(n){gr(n,"onDisconnectEvents");const e=Za(n),t=Rs();Ni(n.onDisconnect_,be(),(i,r)=>{const o=Wd(i,r,n.serverSyncTree_,e);Ia(t,i,o)});let s=[];Ni(t,be(),(i,r)=>{s=s.concat(cs(n.serverSyncTree_,i,r));const o=u_(n,i);yr(n,o)}),n.onDisconnect_=Rs(),Yt(n.eventQueue_,be(),s)}function l_(n){n.persistentConnection_&&n.persistentConnection_.interrupt(Xd)}function gr(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),Ze(t,...e)}function ec(n,e,t){return Ha(n.serverSyncTree_,e,t)||K.EMPTY_NODE}function vr(n,e=n.transactionQueueTree_){if(e||Xs(n,e),An(e)){const t=nc(n,e);A(t.length>0,"Sending zero length transaction queue"),t.every(i=>i.status===0)&&a_(n,hs(e),t)}else $a(e)&&Js(e,t=>{vr(n,t)})}function a_(n,e,t){const s=t.map(c=>c.currentWriteId),i=ec(n,e,s);let r=i;const o=i.hash();for(let c=0;c<t.length;c++){const u=t[c];A(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const f=nt(e,u.path);r=r.updateChild(f,u.currentOutputSnapshotRaw)}const l=r.val(!0),a=e;n.server_.put(a.toString(),l,c=>{gr(n,"transaction put response",{path:a.toString(),status:c});let u=[];if(c==="ok"){const f=[];for(let d=0;d<t.length;d++)t[d].status=2,u=u.concat(dn(n.serverSyncTree_,t[d].currentWriteId)),t[d].onComplete&&f.push(()=>t[d].onComplete(null,!0,t[d].currentOutputSnapshotResolved)),t[d].unwatcher();Xs(n,pr(n.transactionQueueTree_,e)),vr(n,n.transactionQueueTree_),Yt(n.eventQueue_,e,u);for(let d=0;d<f.length;d++)ls(f[d])}else{if(c==="datastale")for(let f=0;f<t.length;f++)t[f].status===3?t[f].status=4:t[f].status=0;else{vt("transaction at "+a.toString()+" failed: "+c);for(let f=0;f<t.length;f++)t[f].status=4,t[f].abortReason=c}yr(n,e)}},o)}function yr(n,e){const t=tc(n,e),s=hs(t),i=nc(n,t);return c_(n,i,s),s}function c_(n,e,t){if(e.length===0)return;const s=[];let i=[];const o=e.filter(l=>l.status===0).map(l=>l.currentWriteId);for(let l=0;l<e.length;l++){const a=e[l],c=nt(t,a.path);let u=!1,f;if(A(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),a.status===4)u=!0,f=a.abortReason,i=i.concat(dn(n.serverSyncTree_,a.currentWriteId,!0));else if(a.status===0)if(a.retryCount>=Zd)u=!0,f="maxretry",i=i.concat(dn(n.serverSyncTree_,a.currentWriteId,!0));else{const d=ec(n,a.path,o);a.currentInputSnapshot=d;const p=e[l].update(d.val());if(p!==void 0){Ja("transaction failed: Data returned ",p,a.path);let g=Qe(p);typeof p=="object"&&p!=null&&Ft(p,".priority")||(g=g.updatePriority(d.getPriority()));const E=a.currentWriteId,T=Za(n),M=Bd(g,d,T);a.currentOutputSnapshotRaw=g,a.currentOutputSnapshotResolved=M,a.currentWriteId=i_(n),o.splice(o.indexOf(E),1),i=i.concat(Id(n.serverSyncTree_,a.path,M,a.currentWriteId,a.applyLocally)),i=i.concat(dn(n.serverSyncTree_,E,!0))}else u=!0,f="nodata",i=i.concat(dn(n.serverSyncTree_,a.currentWriteId,!0))}Yt(n.eventQueue_,t,i),i=[],u&&(e[l].status=2,function(d){setTimeout(d,Math.floor(0))}(e[l].unwatcher),e[l].onComplete&&(f==="nodata"?s.push(()=>e[l].onComplete(null,!1,e[l].currentInputSnapshot)):s.push(()=>e[l].onComplete(new Error(f),!1,null))))}Xs(n,n.transactionQueueTree_);for(let l=0;l<s.length;l++)ls(s[l]);vr(n,n.transactionQueueTree_)}function tc(n,e){let t,s=n.transactionQueueTree_;for(t=_e(e);t!==null&&An(s)===void 0;)s=pr(s,t),e=Ae(e),t=_e(e);return s}function nc(n,e){const t=[];return sc(n,e,t),t.sort((s,i)=>s.order-i.order),t}function sc(n,e,t){const s=An(e);if(s)for(let i=0;i<s.length;i++)t.push(s[i]);Js(e,i=>{sc(n,i,t)})}function Xs(n,e){const t=An(e);if(t){let s=0;for(let i=0;i<t.length;i++)t[i].status!==2&&(t[s]=t[i],s++);t.length=s,Va(e,t.length>0?t:void 0)}Js(e,s=>{Xs(n,s)})}function u_(n,e){const t=hs(tc(n,e)),s=pr(n.transactionQueueTree_,e);return jd(s,i=>{di(n,i)}),di(n,s),Ya(s,i=>{di(n,i)}),t}function di(n,e){const t=An(e);if(t){const s=[];let i=[],r=-1;for(let o=0;o<t.length;o++)t[o].status===3||(t[o].status===1?(A(r===o-1,"All SENT items should be at beginning of queue."),r=o,t[o].status=3,t[o].abortReason="set"):(A(t[o].status===0,"Unexpected transaction status in abort"),t[o].unwatcher(),i=i.concat(dn(n.serverSyncTree_,t[o].currentWriteId,!0)),t[o].onComplete&&s.push(t[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?Va(e,void 0):t.length=r+1,Yt(n.eventQueue_,hs(e),i);for(let o=0;o<s.length;o++)ls(s[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class br{constructor(e,t,s,i){this._repo=e,this._path=t,this._queryParams=s,this._orderByCalled=i}get key(){return ce(this._path)?null:da(this._path)}get ref(){return new xt(this._repo,this._path)}get _queryIdentifier(){const e=Zr(this._queryParams),t=Yi(e);return t==="{}"?"default":t}get _queryObject(){return Zr(this._queryParams)}isEqual(e){if(e=Rn(e),!(e instanceof br))return!1;const t=this._repo===e._repo,s=ma(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+of(this._path)}}class xt extends br{constructor(e,t){super(e,t,new tr,!1)}get parent(){const e=pa(this._path);return e===null?null:new xt(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class ns{constructor(e,t,s){this._node=e,this.ref=t,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new Ne(e),s=Mi(this.ref,e);return new ns(this._node.getChild(t),s,Fe)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new ns(i,Mi(this.ref,s),Fe)))}hasChild(e){const t=new Ne(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function g_(n,e){return n=Rn(n),n._checkNotDeleted("ref"),e!==void 0?Mi(n._root,e):n._root}function Mi(n,e){return n=Rn(n),_e(n._path)===null?Vd("child","path",e,!1):Xa("child","path",e,!1),new xt(n._repo,He(n._path,e))}function v_(n){n=Rn(n);const e=new m_(()=>{}),t=new wr(e);return r_(n._repo,n,t).then(s=>new ns(s,new xt(n._repo,n._path),n._queryParams.getIndex()))}class wr{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const s=t._queryParams.getIndex();return new __("value",this,new ns(e.snapshotNode,new xt(t._repo,t._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new p_(this,e,t):null}matches(e){return e instanceof wr?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function y_(n,...e){let t=Rn(n);for(const s of e)t=s._apply(t);return t}md(xt);wd(xt);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
${location.origin+location.pathname}`),t(1,u=!0),setTimeout(()=>t(1,u=!1),1e3)};return n.$$set=d=>{"gameNumber"in d&&t(5,o=d.gameNumber)},[c,u,s,l,a,o,f]}class ap extends _t{constructor(e){super(),dt(this,e,lp,op,lt,{gameNumber:5})}}function Go(n,e,t){const s=n.slice();return s[5]=e[t][0],s[6]=e[t][1],s}function zo(n){let e,t,s=n[5]+"",i,r,o,l,a,c=n[6]+"",u,f;return{c(){e=m("div"),t=m("span"),i=q(s),r=w(),o=m("span"),o.innerHTML="",l=w(),a=m("span"),u=q(c),f=w(),_(t,"id","guessNum"),_(t,"class","svelte-mzhi8s"),_(o,"class","posrel border-tp svelte-mzhi8s"),_(o,"id","winsBar"),wn(o,"width",`${n[6]*80/n[3]}%`),_(a,"class","smaller-fs svelte-mzhi8s"),_(a,"id","winsNum"),_(e,"class","flex fai-center svelte-mzhi8s")},m(d,p){k(d,e,p),h(e,t),h(t,i),h(e,r),h(e,o),h(e,l),h(e,a),h(a,u),h(e,f)},p(d,p){p&2&&s!==(s=d[5]+"")&&he(i,s),p&10&&wn(o,"width",`${d[6]*80/d[3]}%`),p&2&&c!==(c=d[6]+"")&&he(u,c)},d(d){d&&S(e)}}}function cp(n){let e,t,s,i=Rt(n[2])+"",r,o,l,a,c,u,f=n[1].gamesPlayed+"",d,p,g,v,E,T,M=Math.floor(n[1].gamesWon*100/(n[1].gamesPlayed?n[1].gamesPlayed:1))+"",P,y,I,L,D,O,G,X=n[1].streak+"",te,W,oe,ve,j,H,V=n[1].maxStreak+"",Ee,$,z,Y,N,U,B,ge,F,pe=Ce(Object.entries(n[1].winInfo)),ne=[];for(let J=0;J<pe.length;J+=1)ne[J]=zo(Go(n,pe,J));return{c(){e=m("div"),t=m("span"),s=q("Your Stats - "),r=q(i),o=w(),l=m("div"),a=m("div"),c=m("div"),u=m("span"),d=q(f),p=w(),g=m("span"),g.textContent="Games Played",v=w(),E=m("div"),T=m("span"),P=q(M),y=q("%"),I=w(),L=m("span"),L.textContent="Win Rate",D=w(),O=m("div"),G=m("span"),te=q(X),W=w(),oe=m("span"),oe.textContent="Current Streak",ve=w(),j=m("div"),H=m("span"),Ee=q(V),$=w(),z=m("span"),z.textContent="Max Streak",Y=w(),N=m("span"),N.textContent="Win Distribution",U=w(),B=m("div");for(let J=0;J<ne.length;J+=1)ne[J].c();_(g,"id","statsTitle"),_(g,"class","svelte-mzhi8s"),_(c,"class","svelte-mzhi8s"),_(L,"id","statsTitle"),_(L,"class","svelte-mzhi8s"),_(E,"class","svelte-mzhi8s"),_(oe,"id","statsTitle"),_(oe,"class","svelte-mzhi8s"),_(O,"class","svelte-mzhi8s"),_(z,"id","statsTitle"),_(z,"class","svelte-mzhi8s"),_(j,"class","svelte-mzhi8s"),_(a,"class","flex svelte-mzhi8s"),_(a,"id","playerStatsInfo"),_(N,"class","smaller-fs"),_(B,"class","flex fd-col smaller-fs svelte-mzhi8s"),_(B,"id","distributionChart"),_(e,"class","statsCont ff-bg flex fd-col fai-center border-tp br-1 bs"),_(e,"id","playerStats")},m(J,Ie){k(J,e,Ie),h(e,t),h(t,s),h(t,r),h(e,o),h(e,l),h(l,a),h(a,c),h(c,u),h(u,d),h(c,p),h(c,g),h(a,v),h(a,E),h(E,T),h(T,P),h(T,y),h(E,I),h(E,L),h(a,D),h(a,O),h(O,G),h(G,te),h(O,W),h(O,oe),h(a,ve),h(a,j),h(j,H),h(H,Ee),h(j,$),h(j,z),h(e,Y),h(e,N),h(e,U),h(e,B);for(let ye=0;ye<ne.length;ye+=1)ne[ye]&&ne[ye].m(B,null);F=!0},p(J,[Ie]){if(n=J,(!F||Ie&4)&&i!==(i=Rt(n[2])+"")&&he(r,i),(!F||Ie&2)&&f!==(f=n[1].gamesPlayed+"")&&he(d,f),(!F||Ie&2)&&M!==(M=Math.floor(n[1].gamesWon*100/(n[1].gamesPlayed?n[1].gamesPlayed:1))+"")&&he(P,M),(!F||Ie&2)&&X!==(X=n[1].streak+"")&&he(te,X),(!F||Ie&2)&&V!==(V=n[1].maxStreak+"")&&he(Ee,V),Ie&10){pe=Ce(Object.entries(n[1].winInfo));let ye;for(ye=0;ye<pe.length;ye+=1){const Ge=Go(n,pe,ye);ne[ye]?ne[ye].p(Ge,Ie):(ne[ye]=zo(Ge),ne[ye].c(),ne[ye].m(B,null))}for(;ye<ne.length;ye+=1)ne[ye].d(1);ne.length=pe.length}},i(J){F||(J&&qe(()=>{F&&(ge||(ge=Re(e,ze,{duration:n[0]?200:0},!0)),ge.run(1))}),F=!0)},o(J){J&&(ge||(ge=Re(e,ze,{duration:n[0]?200:0},!1)),ge.run(0)),F=!1},d(J){J&&S(e),Xe(ne,J),J&&ge&&ge.end()}}}function up(n,e,t){let s,i,r,o;me(n,rt,a=>t(4,r=a)),me(n,Ct,a=>t(1,o=a));let{prompted:l=!1}=e;return n.$$set=a=>{"prompted"in a&&t(0,l=a.prompted)},n.$$.update=()=>{n.$$.dirty&2&&t(3,s=Math.max(...Object.values(o.winInfo))),n.$$.dirty&16&&t(2,i=r.mode)},[l,o,i,s,r]}class ac extends _t{constructor(e){super(),dt(this,e,up,cp,lt,{prompted:0})}}function Vo(n,e,t){const s=n.slice();return s[5]=e[t],s}function hp(n){let e,t=Ce(n[1]),s=[];for(let i=0;i<t.length;i+=1)s[i]=$o(Vo(n,t,i));return{c(){for(let i=0;i<s.length;i+=1)s[i].c();e=bt()},m(i,r){for(let o=0;o<s.length;o+=1)s[o]&&s[o].m(i,r);k(i,e,r)},p(i,r){if(r&2){t=Ce(i[1]);let o;for(o=0;o<t.length;o+=1){const l=Vo(i,t,o);s[o]?s[o].p(l,r):(s[o]=$o(l),s[o].c(),s[o].m(e.parentNode,e))}for(;o<s.length;o+=1)s[o].d(1);s.length=t.length}},d(i){i&&S(e),Xe(s,i)}}}function fp(n){let e,t,s;return{c(){e=m("span"),t=q("— "),s=q(n[1]),_(e,"id","info"),_(e,"class","svelte-1vq8gvl")},m(i,r){k(i,e,r),h(e,t),h(e,s)},p(i,r){r&2&&he(s,i[1])},d(i){i&&S(e)}}}function $o(n){let e,t,s=n[5]+"",i;return{c(){e=m("span"),t=q("— "),i=q(s),_(e,"id","info"),_(e,"class","svelte-1vq8gvl")},m(r,o){k(r,e,o),h(e,t),h(e,i)},p(r,o){o&2&&s!==(s=r[5]+"")&&he(i,s)},d(r){r&&S(e)}}}function dp(n){let e,t,s,i,r,o,l;function a(f,d){return typeof f[1]=="string"?fp:hp}let c=a(n),u=c(n);return{c(){e=m("li"),t=m("span"),s=q("v"),i=q(n[0]),r=w(),o=m("i"),o.textContent=`${n[3][n[2][1]-1]+" "+n[2][0]+(Math.floor(n[2][0]/10)===1?"th":W_[n[2][0]%10])+", 20"+n[2][2]}`,l=w(),u.c(),_(t,"id","version"),_(t,"class","svelte-1vq8gvl"),_(o,"id","date"),_(o,"class","svelte-1vq8gvl"),_(e,"class","flex fw fai-center svelte-1vq8gvl")},m(f,d){k(f,e,d),h(e,t),h(t,s),h(t,i),h(e,r),h(e,o),h(e,l),u.m(e,null)},p(f,[d]){d&1&&he(i,f[0]),c===(c=a(f))&&u?u.p(f,d):(u.d(1),u=c(f),u&&(u.c(),u.m(e,null)))},i:ee,o:ee,d(f){f&&S(e),u.d()}}}function _p(n,e,t){let{version:s,date:i,text:r}=e,o=i.split("/"),l=["January","February","March","April","May","June","July","August","Semptember","October","November","December"];return n.$$set=a=>{"version"in a&&t(0,s=a.version),"date"in a&&t(4,i=a.date),"text"in a&&t(1,r=a.text)},[s,r,o,l,i]}class Yo extends _t{constructor(e){super(),dt(this,e,_p,dp,lt,{version:0,date:4,text:1})}}function pp(n){let e,t,s,i,r,o,l;return i=new Yo({props:{version:"1.1.0",date:"4/4/24",text:["Added 'Weapons' game category","'Game Help' prompt now appears on first visit"]}}),o=new Yo({props:{version:"1.0.0",date:"2/4/24",text:"v1 Release"}}),{c(){e=m("span"),e.textContent="Changelog",t=w(),s=m("ul"),ht(i.$$.fragment),r=w(),ht(o.$$.fragment),_(e,"class","title"),_(s,"class","flex fd-col smaller-fs svelte-1hn7lke"),_(s,"id","contents")},m(a,c){k(a,e,c),k(a,t,c),k(a,s,c),st(i,s,null),h(s,r),st(o,s,null),l=!0},p:ee,i(a){l||(Q(i.$$.fragment,a),Q(o.$$.fragment,a),l=!0)},o(a){ue(i.$$.fragment,a),ue(o.$$.fragment,a),l=!1},d(a){a&&(S(e),S(t),S(s)),it(i),it(o)}}}class mp extends _t{constructor(e){super(),dt(this,e,null,pp,lt,{})}}function gp(n){let e,t,s;return{c(){e=m("span"),e.textContent="Credits",t=w(),s=m("div"),s.innerHTML=`<p class="flex fai-center svelte-19w41p3">This is a personal project. Contact me directly on
        ...
        <a class="flex fjc-center fai-center cg-1 svelte-19w41p3" href="https://fantastic-frontier-roblox.fandom.com/wiki/Fantastic_Frontier_-_Roblox_Wiki" target="_blank"><iconify-icon id="fandom" icon="simple-icons:fandom" class="svelte-19w41p3"></iconify-icon>
            ...
            Nini, for the moral support (and anime isaac seen here)</span> <span>— All other daily games which Frontierdle was based on</span></p>`,_(e,"class","title"),_(s,"class","smaller-fs"),_(s,"id","contents")},m(i,r){k(i,e,r),k(i,t,r),k(i,s,r)},p:ee,i:ee,o:ee,d(i){i&&(S(e),S(t),S(s))}}}class vp extends _t{constructor(e){super(),dt(this,e,null,gp,lt,{})}}function Ko(n,e,t){const s=n.slice();return s[0]=e[t],s}function yp(n,e,t){const s=n.slice();return s[3]=e[t],s}function bp(n,e,t){const s=n.slice();return s[6]=e[t],s}function Qo(n,e,t){const s=n.slice();return s[9]=e[t],s}function Jo(n,e,t){const s=n.slice();return s[12]=e[t],s}function wp(n,e,t){const s=n.slice();return s[15]=e[t],s}function Cp(n){let e;return{c(){e=m("li"),e.textContent=`— ${Rt(n[15])} `},m(t,s){k(t,e,s)},p:ee,d(t){t&&S(e)}}}function Xo(n){let e;return{c(){e=m("li"),e.textContent=`— ${n[12]} `},m(t,s){k(t,e,s)},p:ee,d(t){t&&S(e)}}}function Zo(n){let e;return{c(){e=m("li"),e.textContent=`— ${n[9]}`},m(t,s){k(t,e,s)},p:ee,d(t){t&&S(e)}}}function Ep(n){let e;return{c(){e=m("li"),e.textContent=`— ${n[6]}`},m(t,s){k(t,e,s)},p:ee,d(t){t&&S(e)}}}function Ip(n){let e;return{c(){e=m("li"),e.textContent=`— ${n[3]}`},m(t,s){k(t,e,s)},p:ee,d(t){t&&S(e)}}}function el(n){let e;return{c(){e=m("li"),e.textContent=`— ${n[0]} Update`},m(t,s){k(t,e,s)},p:ee,d(t){t&&S(e)}}}function Sp(n){let e,t,s,i,r,o,l,a,c,u,f,d,p,g,v,E,T,M,P,y,I,L,D,O,G,X,te,W,oe,ve,j,H,V,Ee,$,z,Y,N,U,B,ge,F,pe,ne,J,Ie,ye,Ge,Be,We,et,Ke,le,wt=Ce(F_),we=[];for(let C=0;C<wt.length;C+=1)we[C]=Cp(wp(n,wt,C));let Se=Ce(Object.values(Ws)),Oe=[];for(let C=0;C<Se.length;C+=1)Oe[C]=Xo(Jo(n,Se,C));let Me=Ce(Object.values(Bs)),fe=[];for(let C=0;C<Me.length;C+=1)fe[C]=Zo(Qo(n,Me,C));let ke=Ce(["Black","Blue","Brown","Gray","Green","None","Orange","Pink","Purple","Red","White","Yellow"]),ae=[];for(let C=0;C<12;C+=1)ae[C]=Ep(bp(n,ke,C));let x=Ce(["Black","Blue","Green","Purple","Red","White","Yellow"]),se=[];for(let C=0;C<7;C+=1)se[C]=Ip(yp(n,x,C));let Te=Ce(Object.values(xs).slice(0,-1)),de=[];for(let C=0;C<Te.length;C+=1)de[C]=el(Ko(n,Te,C));return{c(){e=m("span"),e.textContent="Game Help",t=w(),s=m("div"),i=m("p"),i.textContent=`Frontierdle works similarly to many other daily games. You have a\r
        ...
        Fantastic Frontier, which changes every day.`,r=w(),o=m("div"),o.innerHTML=`<span class="title">Color Guide</span> <div class="flex svelte-f1c9xj" id="colorGuide"><span class="flex fjc-center fai-center ff-bg ff-item svelte-f1c9xj" id="correct">Correct</span> <span class="flex fjc-center fai-center ff-bg ff-item posrel svelte-f1c9xj" id="partial">Partial
            ...
            more expensive (up) or cheaper (down) than the guessed item.</span>`,l=w(),a=m("span"),a.textContent="Categories",c=w(),u=m("div"),f=m("div"),d=m("b"),d.textContent="Equipment",p=w(),g=m("span"),v=m("b"),v.textContent="Slot:",E=w(),T=m("ul");for(let C=0;C<we.length;C+=1)we[C].c();M=w(),P=m("span"),y=m("b"),y.textContent="Stats:",I=w(),L=m("ul");for(let C=0;C<Oe.length;C+=1)Oe[C].c();D=w(),O=m("div"),G=m("b"),G.textContent="Weapons",X=w(),te=m("span"),te.innerHTML="<b>Has Special:</b> <span>Whether the weapon has a Special Ability.</span>",W=w(),oe=m("span"),ve=m("b"),ve.textContent="Stat Intakes:",j=w(),H=m("ul");for(let C=0;C<fe.length;C+=1)fe[C].c();V=w(),Ee=m("div"),$=m("div"),z=m("b"),z.textContent="General",Y=w(),N=m("span"),N.innerHTML=`<b>Avg. Cost:</b> <span>The average of all possible prices the item can be purchased
                    at. &quot;Unpurchasable&quot; if it cannot be purchased, equivalent to
                    0 for the game&#39;s purposes.</span>`,U=w(),B=m("span"),ge=m("b"),ge.textContent="Colors:",F=w(),pe=m("ul");for(let C=0;C<12;C+=1)ae[C].c();ne=w(),J=m("span"),Ie=m("b"),Ie.textContent="Outline:",ye=w(),Ge=m("ul");for(let C=0;C<7;C+=1)se[C].c();Be=w(),We=m("span"),et=m("b"),et.textContent="Release:",Ke=w(),le=m("ul");for(let C=0;C<de.length;C+=1)de[C].c();_(e,"class","title"),_(o,"class","flex fd-col fai-center"),_(a,"class","title"),_(d,"class","categoryTitle svelte-f1c9xj"),_(v,"class","svelte-f1c9xj"),_(T,"class","svelte-f1c9xj"),_(g,"class","flex fd-col smaller-fs list svelte-f1c9xj"),_(y,"class","svelte-f1c9xj"),_(L,"class","svelte-f1c9xj"),_(P,"class","flex fd-col smaller-fs list svelte-f1c9xj"),_(f,"class","flex fw fjc-center categories svelte-f1c9xj"),_(G,"class","categoryTitle svelte-f1c9xj"),_(te,"class","flex fd-col smaller-fs limit-width svelte-f1c9xj"),_(ve,"class","svelte-f1c9xj"),_(H,"class","svelte-f1c9xj"),_(oe,"class","flex fd-col smaller-fs list svelte-f1c9xj"),_(O,"class","flex fw fjc-center categories svelte-f1c9xj"),_(u,"class","flex categoriesCont svelte-f1c9xj"),_(z,"class","categoryTitle svelte-f1c9xj"),_(N,"class","flex fd-col smaller-fs limit-width svelte-f1c9xj"),_(ge,"class","svelte-f1c9xj"),_(pe,"class","svelte-f1c9xj"),_(B,"class","flex fd-col smaller-fs list svelte-f1c9xj"),_(Ie,"class","svelte-f1c9xj"),_(Ge,"class","svelte-f1c9xj"),_(J,"class","flex fd-col smaller-fs list svelte-f1c9xj"),_(et,"class","svelte-f1c9xj"),_(le,"class","svelte-f1c9xj"),_(We,"class","flex fd-col smaller-fs list svelte-f1c9xj"),_($,"class","flex fw fjc-center categories svelte-f1c9xj"),_(Ee,"class","flex categoriesCont svelte-f1c9xj"),_(s,"class","flex fd-col smaller-fs svelte-f1c9xj"),_(s,"id","contents")},m(C,ie){k(C,e,ie),k(C,t,ie),k(C,s,ie),h(s,i),h(s,r),h(s,o),h(s,l),h(s,a),h(s,c),h(s,u),h(u,f),h(f,d),h(f,p),h(f,g),h(g,v),h(g,E),h(g,T);for(let R=0;R<we.length;R+=1)we[R]&&we[R].m(T,null);h(f,M),h(f,P),h(P,y),h(P,I),h(P,L);for(let R=0;R<Oe.length;R+=1)Oe[R]&&Oe[R].m(L,null);h(u,D),h(u,O),h(O,G),h(O,X),h(O,te),h(O,W),h(O,oe),h(oe,ve),h(oe,j),h(oe,H);for(let R=0;R<fe.length;R+=1)fe[R]&&fe[R].m(H,null);h(s,V),h(s,Ee),h(Ee,$),h($,z),h($,Y),h($,N),h($,U),h($,B),h(B,ge),h(B,F),h(B,pe);for(let R=0;R<12;R+=1)ae[R]&&ae[R].m(pe,null);h($,ne),h($,J),h(J,Ie),h(J,ye),h(J,Ge);for(let R=0;R<7;R+=1)se[R]&&se[R].m(Ge,null);h($,Be),h($,We),h(We,et),h(We,Ke),h(We,le);for(let R=0;R<de.length;R+=1)de[R]&&de[R].m(le,null)},p(C,[ie]){if(ie&0){Se=Ce(Object.values(Ws));let R;for(R=0;R<Se.length;R+=1){const pt=Jo(C,Se,R);Oe[R]?Oe[R].p(pt,ie):(Oe[R]=Xo(pt),Oe[R].c(),Oe[R].m(L,null))}for(;R<Oe.length;R+=1)Oe[R].d(1);Oe.length=Se.length}if(ie&0){Me=Ce(Object.values(Bs));let R;for(R=0;R<Me.length;R+=1){const pt=Qo(C,Me,R);fe[R]?fe[R].p(pt,ie):(fe[R]=Zo(pt),fe[R].c(),fe[R].m(H,null))}for(;R<fe.length;R+=1)fe[R].d(1);fe.length=Me.length}if(ie&0){Te=Ce(Object.values(xs).slice(0,-1));let R;for(R=0;R<Te.length;R+=1){const pt=Ko(C,Te,R);de[R]?de[R].p(pt,ie):(de[R]=el(pt),de[R].c(),de[R].m(le,null))}for(;R<de.length;R+=1)de[R].d(1);de.length=Te.length}},i:ee,o:ee,d(C){C&&(S(e),S(t),S(s)),Xe(we,C),Xe(Oe,C),Xe(fe,C),Xe(ae,C),Xe(se,C),Xe(de,C)}}}class cc extends _t{constructor(e){super(),dt(this,e,null,Sp,lt,{})}}function Tp(n){let e,t,s;return{c(){e=m("span"),e.textContent="Frontierdle Policy",t=w(),s=m("div"),s.innerHTML=`<span class="subtitle">About</span> <p>This tool is a passion project, one that is independent and is not
        ...
        analyzed.</p> <span class="subtitle">Contact</span> <p>For any questions or inquiries, feel free to contact us at <hl>@xt.ss</hl>.</p>`,_(e,"class","title"),_(s,"class","flex fd-col smaller-fs svelte-932r7h"),_(s,"id","contents")},m(i,r){k(i,e,r),k(i,t,r),k(i,s,r)},p:ee,i:ee,o:ee,d(i){i&&(S(e),S(t),S(s))}}}class kp extends _t{constructor(e){super(),dt(this,e,null,Tp,lt,{})}}function tl(n){let e,t,s;return{c(){e=m("iconify-icon"),xe(e,"icon","uil:exclamation"),xe(e,"id","unseen"),xe(e,"class","svelte-1aydprt")},m(i,r){k(i,e,r),s=!0},i(i){s||(i&&qe(()=>{s&&(t||(t=Re(e,Mt,{duration:150},!0)),t.run(1))}),s=!0)},o(i){i&&(t||(t=Re(e,Mt,{duration:150},!1)),t.run(0)),s=!1},d(i){i&&S(e),i&&t&&t.end()}}}function Np(n){let e,t,s,i,r,o,l,a,c,u,f,d,p,g,v,E,T,M,P=!n[2]&&tl();return{c(){e=m("button"),e.innerHTML='<iconify-icon icon="octicon:people-16"></iconify-icon> <span class="tooltip" id="right">Credits</span>',t=w(),s=m("button"),s.innerHTML=`<a href="https://ko-fi.com/xt8ss" target="_blank" class="svelte-1aydprt">Support me
        <img src="misc/kofi-badge.png" alt="" class="svelte-1aydprt"/></a>`,i=w(),r=m("button"),r.innerHTML='<iconify-icon icon="material-symbols:help-outline-rounded"></iconify-icon> <span class="tooltip" id="left">Help</span>',o=w(),l=m("button"),a=m("iconify-icon"),c=w(),u=m("span"),u.textContent="Changelog",f=w(),P&&P.c(),d=w(),p=m("button"),p.innerHTML='<iconify-icon icon="material-symbols:policy-outline-rounded"></iconify-icon> <span class="tooltip" id="left">Policy</span>',g=w(),v=m("span"),E=q(n[0]),_(e,"class","info p-1 svelte-1aydprt"),_(e,"id","credits"),_(s,"class","info p-1 svelte-1aydprt"),_(s,"id","donate"),_(r,"class","info p-1 svelte-1aydprt"),_(r,"id","help"),xe(a,"icon","octicon:log-16"),_(u,"class","tooltip"),_(u,"id","right"),_(l,"class","info svelte-1aydprt"),_(l,"id","changelog"),_(p,"class","info p-1 svelte-1aydprt"),_(p,"id","policy"),_(v,"class","info svelte-1aydprt"),_(v,"id","version")},m(y,I){k(y,e,I),k(y,t,I),k(y,s,I),k(y,i,I),k(y,r,I),k(y,o,I),k(y,l,I),h(l,a),h(l,c),h(l,u),h(l,f),P&&P.m(l,null),k(y,d,I),k(y,p,I),k(y,g,I),k(y,v,I),h(v,E),T||(M=[Le(e,"click",n[3]),Le(r,"click",n[4]),Le(l,"click",n[5]),Le(p,"click",n[6])],T=!0)},p(y,[I]){y[2]?P&&(mt(),ue(P,1,1,()=>{P=null}),gt()):P?I&4&&Q(P,1):(P=tl(),P.c(),Q(P,1),P.m(l,null)),I&1&&he(E,y[0])},i(y){Q(P)},o(y){ue(P)},d(y){y&&(S(e),S(t),S(s),S(i),S(r),S(o),S(l),S(d),S(p),S(g),S(v)),P&&P.d(),T=!1,ot(M)}}}function Rp(n,e,t){let s,i;me(n,tt,u=>t(1,s=u)),me(n,ss,u=>t(2,i=u));let{version:r}=e;const o=u=>{Pt(u),Z(tt,s.component=vp,s)},l=u=>{Pt(u),Z(tt,s.component=cc,s)},a=u=>{Pt(u),Z(tt,s.component=mp,s),Z(ss,i=!0,i)},c=u=>{Pt(u),Z(tt,s.component=kp,s)};return n.$$set=u=>{"version"in u&&t(0,r=u.version)},[r,s,i,o,l,a,c]}class Dp extends _t{constructor(e){super(),dt(this,e,Rp,Np,lt,{version:0})}}function Ap(n){let e,t,s,i,r,o,l,a,c,u,f,d,p,g,v,E;return{c(){e=m("div"),t=m("span"),t.textContent="Choose your category",s=w(),i=m("button"),r=m("img"),l=w(),a=m("span"),a.textContent="Equipment",c=w(),u=m("button"),f=m("img"),p=w(),g=m("span"),g.textContent="Weapons",_(t,"id","title"),_(t,"class","svelte-jlt3e9"),Ue(r.src,o="https://static.wikia.nocookie.net/fantastic-frontier-roblox/images/7/7a/WhiteSpectralVanguardIcon.png")||_(r,"src",o),_(r,"alt",""),_(r,"class","svelte-jlt3e9"),i.disabled=n[0],_(i,"class","modeCont ff-item flex fd-col fjc-center fai-center smaller-fs svelte-jlt3e9"),Ye(i,"selected",n[1].mode=="equipment"),Ue(f.src,d="https://static.wikia.nocookie.net/fantastic-frontier-roblox/images/9/95/TheJadeTwin.png")||_(f,"src",d),_(f,"alt",""),_(f,"class","svelte-jlt3e9"),u.disabled=n[0],_(u,"class","modeCont ff-item flex fd-col fjc-center fai-center smaller-fs svelte-jlt3e9"),Ye(u,"selected",n[1].mode=="weapons"),_(e,"class","chooseModeCont ff-bg flex fd-row fw border-tp br-1 bs svelte-jlt3e9")},m(T,M){k(T,e,M),h(e,t),h(e,s),h(e,i),h(i,r),h(i,l),h(i,a),h(e,c),h(e,u),h(u,f),h(u,p),h(u,g),v||(E=[Le(i,"click",n[2]),Le(u,"click",n[3])],v=!0)},p(T,[M]){M&1&&(i.disabled=T[0]),M&2&&Ye(i,"selected",T[1].mode=="equipment"),M&1&&(u.disabled=T[0]),M&2&&Ye(u,"selected",T[1].mode=="weapons")},i:ee,o:ee,d(T){T&&S(e),v=!1,ot(E)}}}function Pp(n,e,t){let s,i;return me(n,rn,l=>t(0,s=l)),me(n,rt,l=>t(1,i=l)),[s,i,l=>{Pt(l),s||Z(rt,i.mode="equipment",i)},l=>{Pt(l),s||Z(rt,i.mode="weapons",i)}]}class Op extends _t{constructor(e){super(),dt(this,e,Pp,Ap,lt,{})}}const{document:ps}=pc;function nl(n,e,t){const s=n.slice();return s[68]=e[t],s}function sl(n,e,t){const s=n.slice();return s[68]=e[t],s}function il(n){let e;return{c(){e=m("link"),_(e,"rel","preload"),_(e,"as","image"),_(e,"href",n[68])},m(t,s){k(t,e,s)},p:ee,d(t){t&&S(e)}}}function rl(n){let e;return{c(){e=m("style"),e.textContent=`*:not(.promptCont, .promptCont *) {
            ...
            .info:not(#zoomLevel, #version) {
                filter: blur(0.375vh);
                pointer-events: none;
            }`},m(t,s){k(t,e,s)},d(t){t&&S(e)}}}function ol(n){let e,t;return{c(){e=m("img"),_(e,"class","background svelte-1vlfqbw"),Ue(e.src,t=n[68])||_(e,"src",t),_(e,"alt",""),Ye(e,"active",n[30].indexOf(n[68])==n[22])},m(s,i){k(s,e,i)},p(s,i){i[0]&1077936128&&Ye(e,"active",s[30].indexOf(s[68])==s[22])},d(s){s&&S(e)}}}function ll(n){let e,t,s=Math.floor(n[27][n[2]]*100)+"",i,r,o,l;return{c(){e=m("span"),t=q("Zoom: "),i=q(s),r=m("b"),r.textContent="%",_(e,"class","info svelte-1vlfqbw"),_(e,"id","zoomLevel")},m(a,c){k(a,e,c),h(e,t),h(e,i),h(e,r),l=!0},p(a,c){(!l||c[0]&4)&&s!==(s=Math.floor(a[27][a[2]]*100)+"")&&he(i,s)},i(a){l||(a&&qe(()=>{l&&(o||(o=Re(e,Mt,{duration:150},!0)),o.run(1))}),l=!0)},o(a){a&&(o||(o=Re(e,Mt,{duration:150},!1)),o.run(0)),l=!1},d(a){a&&S(e),a&&o&&o.end()}}}function al(n){let e,t,s,i,r,o,l,a,c=n[8].muted?"Muted":"Unmuted",u,f,d,p,g,v,E,T,M,P,y,I=js(n[19],n[20],n[21])+"",L,D,O,G,X,te,W,oe,ve,j,H,V,Ee,$,z=n[3].includes("equipment")?"stat":" stat intake",Y,N,U,B,ge,F,pe,ne,J,Ie,ye,Ge,Be,We,et,Ke,le,wt;X=new Op({}),F=new Z_({props:{size:"5",checked:n[4],disabled:n[5].chosenItems.length!=0}}),F.$on("toggle",n[44]);let we=!n[5].gameWin&&!n[5].gameOver&&cl(n),Se=(n[5].gameWin||n[5].gameOver)&&ul(n);function Oe(x){n[47](x)}let Me={};n[11]!==void 0&&(Me.dailyItemsData=n[11]),Ie=new Q_({props:Me}),at.push(()=>Gs(Ie,"dailyItemsData",Oe));let fe=n[12][n[3]]&&hl(n),ke=n[24].component&&n[24].complete&&fl(n),ae=n[24].component&&!n[24].complete&&dl(n);return{c(){e=m("main"),t=m("div"),s=m("div"),i=m("button"),r=m("iconify-icon"),l=w(),a=m("span"),u=q(c),f=w(),d=m("button"),p=m("img"),v=w(),E=m("span"),T=q(`Next item in...
                    `),M=m("br"),P=w(),y=new bl(!1),L=w(),D=m("div"),O=m("button"),O.innerHTML='<iconify-icon icon="uis:graph-bar" class="svelte-1vlfqbw"></iconify-icon> <span class="tooltip" id="bottom">Your stats</span>',G=w(),ht(X.$$.fragment),te=w(),W=m("div"),oe=m("button"),ve=m("iconify-icon"),j=w(),H=m("span"),V=q(`No armor (more damage taken).
                    `),Ee=m("br"),$=q(`
                    No `),Y=q(z),N=q(` / avg.
                    cost / color clues.`),U=w(),B=m("span"),B.textContent="Nightmare Mode",ge=w(),ht(F.$$.fragment),pe=w(),we&&we.c(),ne=w(),Se&&Se.c(),J=w(),ht(Ie.$$.fragment),Ge=w(),fe&&fe.c(),Be=w(),ke&&ke.c(),We=w(),ae&&ae.c(),et=bt(),xe(r,"icon",o="f7:speaker-"+(n[8].muted?"slash":"2")+"-fill"),xe(r,"class","svelte-1vlfqbw"),_(a,"class","tooltip"),_(a,"id","bottom"),_(i,"class","flex light-hover svelte-1vlfqbw"),_(s,"class","iconToggle ff-bg posrel border-tp br-1 bs svelte-1vlfqbw"),Ue(p.src,g="frontierdle.svg")||_(p,"src",g),_(p,"alt","Frontierdle"),_(p,"class","svelte-1vlfqbw"),y.a=null,_(E,"class","tooltip svelte-1vlfqbw"),_(E,"id","bottom"),_(d,"class","iconCont ff-bg posrel border-tp br-1 bs no-bg-change svelte-1vlfqbw"),_(O,"class","flex posrel light-hover svelte-1vlfqbw"),_(D,"class","iconToggle ff-bg border-tp br-1 bs svelte-1vlfqbw"),_(t,"class","upperMenu flex fai-center svelte-1vlfqbw"),xe(ve,"icon","eva:info-outline"),xe(ve,"id","info"),xe(ve,"class","svelte-1vlfqbw"),_(H,"class","tooltip svelte-1vlfqbw"),_(H,"id","bottom"),_(oe,"class","flex posrel no-bg-change"),_(W,"class","hardModeCont ff-bg flex fai-center border-tp br-1 bs svelte-1vlfqbw"),_(e,"class","flex fd-col fai-center posrel svelte-1vlfqbw")},m(x,se){k(x,e,se),h(e,t),h(t,s),h(s,i),h(i,r),h(i,l),h(i,a),h(a,u),h(t,f),h(t,d),h(d,p),h(d,v),h(d,E),h(E,T),h(E,M),h(E,P),y.m(I,E),h(t,L),h(t,D),h(D,O),h(e,G),st(X,e,null),h(e,te),h(e,W),h(W,oe),h(oe,ve),h(oe,j),h(oe,H),h(H,V),h(H,Ee),h(H,$),h(H,Y),h(H,N),h(W,U),h(W,B),h(W,ge),st(F,W,null),h(e,pe),we&&we.m(e,null),h(e,ne),Se&&Se.m(e,null),h(e,J),st(Ie,e,null),h(e,Ge),fe&&fe.m(e,null),k(x,Be,se),ke&&ke.m(x,se),k(x,We,se),ae&&ae.m(x,se),k(x,et,se),Ke=!0,le||(wt=[Le(i,"click",n[42]),Le(O,"click",n[43])],le=!0)},p(x,se){(!Ke||se[0]&256&&o!==(o="f7:speaker-"+(x[8].muted?"slash":"2")+"-fill"))&&xe(r,"icon",o),(!Ke||se[0]&256)&&c!==(c=x[8].muted?"Muted":"Unmuted")&&he(u,c),(!Ke||se[0]&3670016)&&I!==(I=js(x[19],x[20],x[21])+"")&&y.p(I),(!Ke||se[0]&8)&&z!==(z=x[3].includes("equipment")?"stat":" stat intake")&&he(Y,z);const Te={};se[0]&16&&(Te.checked=x[4]),se[0]&32&&(Te.disabled=x[5].chosenItems.length!=0),F.$set(Te),!x[5].gameWin&&!x[5].gameOver?we?(we.p(x,se),se[0]&32&&Q(we,1)):(we=cl(x),we.c(),Q(we,1),we.m(e,ne)):we&&(mt(),ue(we,1,1,()=>{we=null}),gt()),x[5].gameWin||x[5].gameOver?Se?(Se.p(x,se),se[0]&32&&Q(Se,1)):(Se=ul(x),Se.c(),Q(Se,1),Se.m(e,J)):Se&&(mt(),ue(Se,1,1,()=>{Se=null}),gt());const de={};!ye&&se[0]&2048&&(ye=!0,de.dailyItemsData=x[11],Us(()=>ye=!1)),Ie.$set(de),x[12][x[3]]?fe?fe.p(x,se):(fe=hl(x),fe.c(),fe.m(e,null)):fe&&(fe.d(1),fe=null),x[24].component&&x[24].complete?ke?(ke.p(x,se),se[0]&16777216&&Q(ke,1)):(ke=fl(x),ke.c(),Q(ke,1),ke.m(We.parentNode,We)):ke&&(mt(),ue(ke,1,1,()=>{ke=null}),gt()),x[24].component&&!x[24].complete?ae?(ae.p(x,se),se[0]&16777216&&Q(ae,1)):(ae=dl(x),ae.c(),Q(ae,1),ae.m(et.parentNode,et)):ae&&(mt(),ue(ae,1,1,()=>{ae=null}),gt())},i(x){Ke||(Q(X.$$.fragment,x),Q(F.$$.fragment,x),Q(we),Q(Se),Q(Ie.$$.fragment,x),Q(ke),Q(ae),Ke=!0)},o(x){ue(X.$$.fragment,x),ue(F.$$.fragment,x),ue(we),ue(Se),ue(Ie.$$.fragment,x),ue(ke),ue(ae),Ke=!1},d(x){x&&(S(e),S(Be),S(We),S(et)),it(X),it(F),we&&we.d(),Se&&Se.d(),it(Ie),fe&&fe.d(),ke&&ke.d(x),ae&&ae.d(x),le=!1,ot(wt)}}}function cl(n){let e,t,s;function i(o){n[45](o)}let r={};return n[18][n[3]]!==void 0&&(r.gameNumber=n[18][n[3]]),e=new rp({props:r}),at.push(()=>Gs(e,"gameNumber",i)),{c(){ht(e.$$.fragment)},m(o,l){st(e,o,l),s=!0},p(o,l){const a={};!t&&l[0]&262152&&(t=!0,a.gameNumber=o[18][o[3]],Us(()=>t=!1)),e.$set(a)},i(o){s||(Q(e.$$.fragment,o),s=!0)},o(o){ue(e.$$.fragment,o),s=!1},d(o){it(e,o)}}}function ul(n){let e,t,s=n[5].gameWin?"Fantastic!":"Farewell...",i,r,o,l,a,c=n[5].gameWin?"won":"lost",u,f,d,p,g,v,E,T,M,P,y,I,L,D,O=n[11][n[3]].name+"",G,X,te,W,oe,ve,j,H=js(n[19],n[20],n[21])+"",V,Ee,$,z,Y,N,U;function B(F){n[46](F)}let ge={};return n[18][n[3]]!==void 0&&(ge.gameNumber=n[18][n[3]]),$=new ap({props:ge}),at.push(()=>Gs($,"gameNumber",B)),N=new ac({}),{c(){e=m("div"),t=m("span"),i=q(s),r=w(),o=m("img"),a=q(`
                    You `),u=q(c),f=q("!"),d=w(),p=m("span"),p.textContent="Today's item was...",g=w(),v=m("div"),E=m("a"),T=m("img"),P=w(),y=m("iconify-icon"),L=w(),D=m("span"),G=q(O),X=w(),te=m("span"),W=q(`Next item available in...
                    `),oe=m("br"),ve=w(),j=m("span"),Ee=w(),ht($.$$.fragment),Y=w(),ht(N.$$.fragment),Ue(o.src,l=n[5].gameWin?"ff-images/rb-fantastic.png":"ff-images/rb-farewell.png")||_(o,"src",l),_(o,"id","gameFinishIcon"),_(o,"alt",""),_(o,"class","svelte-1vlfqbw"),_(t,"class","flex fai-center svelte-1vlfqbw"),_(t,"id","gameFinishMessage"),_(p,"class","smaller-fs"),Ue(T.src,M=$t+n[11][n[3]].image)||_(T,"src",M),_(T,"alt",""),_(T,"class","svelte-1vlfqbw"),xe(y,"icon","tabler:link"),xe(y,"class","svelte-1vlfqbw"),_(E,"class","flex fjc-center fai-center svelte-1vlfqbw"),_(E,"href",I=Tn+n[11][n[3]].link),_(E,"target","_blank"),_(v,"class","itemImg ff-item flex svelte-1vlfqbw"),_(v,"id","dailyItemImg"),_(D,"class","ff-item itemName svelte-1vlfqbw"),_(D,"id","dailyItemName"),_(j,"class","ff-item svelte-1vlfqbw"),_(j,"id","nextItemTime"),_(te,"class","flex fd-col svelte-1vlfqbw"),_(te,"id","nextItemCont"),_(e,"class","gameFinishCont ff-bg flex fd-col fai-center border-tp br-1 bs svelte-1vlfqbw")},m(F,pe){k(F,e,pe),h(e,t),h(t,i),h(t,r),h(t,o),h(t,a),h(t,u),h(t,f),h(e,d),h(e,p),h(e,g),h(e,v),h(v,E),h(E,T),h(E,P),h(E,y),h(e,L),h(e,D),h(D,G),h(e,X),h(e,te),h(te,W),h(te,oe),h(te,ve),h(te,j),j.innerHTML=H,k(F,Ee,pe),st($,F,pe),k(F,Y,pe),st(N,F,pe),U=!0},p(F,pe){(!U||pe[0]&32)&&s!==(s=F[5].gameWin?"Fantastic!":"Farewell...")&&he(i,s),(!U||pe[0]&32&&!Ue(o.src,l=F[5].gameWin?"ff-images/rb-fantastic.png":"ff-images/rb-farewell.png"))&&_(o,"src",l),(!U||pe[0]&32)&&c!==(c=F[5].gameWin?"won":"lost")&&he(u,c),(!U||pe[0]&2056&&!Ue(T.src,M=$t+F[11][F[3]].image))&&_(T,"src",M),(!U||pe[0]&2056&&I!==(I=Tn+F[11][F[3]].link))&&_(E,"href",I),(!U||pe[0]&2056)&&O!==(O=F[11][F[3]].name+"")&&he(G,O),(!U||pe[0]&3670016)&&H!==(H=js(F[19],F[20],F[21])+"")&&(j.innerHTML=H);const ne={};!z&&pe[0]&262152&&(z=!0,ne.gameNumber=F[18][F[3]],Us(()=>z=!1)),$.$set(ne)},i(F){U||(F&&qe(()=>{U&&(V||(V=Re(e,Mt,{duration:150},!0)),V.run(1))}),Q($.$$.fragment,F),Q(N.$$.fragment,F),U=!0)},o(F){F&&(V||(V=Re(e,Mt,{duration:150},!1)),V.run(0)),ue($.$$.fragment,F),ue(N.$$.fragment,F),U=!1},d(F){F&&(S(e),S(Ee),S(Y)),F&&V&&V.end(),it($,F),it(N,F)}}}function hl(n){let e,t,s,i,r,o,l,a,c,u,f,d=n[12][n[3]].name+"",p;return{c(){e=m("div"),t=q(`Yesterday's item was...
                `),s=m("div"),i=m("a"),r=m("img"),l=w(),a=m("iconify-icon"),u=w(),f=m("span"),p=q(d),Ue(r.src,o=$t+n[12][n[3]].image)||_(r,"src",o),_(r,"alt",""),_(r,"class","svelte-1vlfqbw"),xe(a,"icon","tabler:link"),xe(a,"class","svelte-1vlfqbw"),_(i,"class","flex fjc-center fai-center svelte-1vlfqbw"),_(i,"href",c=Tn+n[12][n[3]].link),_(i,"target","_blank"),_(s,"class","itemImg ff-item flex svelte-1vlfqbw"),_(s,"id","previousItemImg"),_(f,"class","ff-item itemName svelte-1vlfqbw"),_(f,"id","previousItemName"),_(e,"class","previousItemCont ff-bg flex fd-col fai-center border-tp br-1 bs svelte-1vlfqbw")},m(g,v){k(g,e,v),h(e,t),h(e,s),h(s,i),h(i,r),h(i,l),h(i,a),h(e,u),h(e,f),h(f,p)},p(g,v){v[0]&4104&&!Ue(r.src,o=$t+g[12][g[3]].image)&&_(r,"src",o),v[0]&4104&&c!==(c=Tn+g[12][g[3]].link)&&_(i,"href",c),v[0]&4104&&d!==(d=g[12][g[3]].name+"")&&he(p,d)},d(g){g&&S(e)}}}function fl(n){let e,t,s,i,r;var o=n[24].component;function l(a,c){return{props:{prompted:!0}}}return o&&(t=gs(o,l())),{c(){e=m("div"),t&&ht(t.$$.fragment),_(e,"class","promptCont")},m(a,c){k(a,e,c),t&&st(t,e,null),n[48](e),s=!0,i||(r=Le(e,"click",n[49]),i=!0)},p(a,c){if(c[0]&16777216&&o!==(o=a[24].component)){if(t){mt();const u=t;ue(u.$$.fragment,1,0,()=>{it(u,1)}),gt()}o?(t=gs(o,l()),ht(t.$$.fragment),Q(t.$$.fragment,1),st(t,e,null)):t=null}},i(a){s||(t&&Q(t.$$.fragment,a),s=!0)},o(a){t&&ue(t.$$.fragment,a),s=!1},d(a){a&&S(e),t&&it(t),n[48](null),i=!1,r()}}}function dl(n){let e,t,s,i,r,o,l;var a=n[24].component;function c(u,f){return{props:{prompted:!0}}}return a&&(s=gs(a,c())),{c(){e=m("div"),t=m("div"),s&&ht(s.$$.fragment),_(t,"class","flex fd-col border-tp br-1 bs"),_(e,"class","promptCont")},m(u,f){k(u,e,f),h(e,t),s&&st(s,t,null),n[50](e),r=!0,o||(l=Le(e,"click",n[51]),o=!0)},p(u,f){if(f[0]&16777216&&a!==(a=u[24].component)){if(s){mt();const d=s;ue(d.$$.fragment,1,0,()=>{it(d,1)}),gt()}a?(s=gs(a,c()),ht(s.$$.fragment),Q(s.$$.fragment,1),st(s,t,null)):s=null}},i(u){r||(s&&Q(s.$$.fragment,u),u&&qe(()=>{r&&(i||(i=Re(t,ze,{duration:200},!0)),i.run(1))}),r=!0)},o(u){s&&ue(s.$$.fragment,u),u&&(i||(i=Re(t,ze,{duration:200},!1)),i.run(0)),r=!1},d(u){u&&S(e),s&&it(s),u&&i&&i.end(),n[50](null),o=!1,l()}}}function Mp(n){let e,t,s,i,r,o,l,a,c,u,f,d,p,g,v,E,T,M,P,y,I,L,D,O,G,X=_n(n[7])&&_n(n[6])&&n[9],te,W,oe,ve;qe(n[37]);let j=Ce(n[30]),H=[];for(let N=0;N<j.length;N+=1)H[N]=il(sl(n,j,N));let V=n[24].component&&rl(),Ee=Ce(n[30]),$=[];for(let N=0;N<Ee.length;N+=1)$[N]=ol(nl(n,Ee,N));let z=n[10]&&ll(n);O=new Dp({props:{version:qi}});let Y=X&&al(n);return{c(){for(let N=0;N<H.length;N+=1)H[N].c();e=bt(),V&&V.c(),t=bt(),s=w(),i=m("div"),r=m("audio"),a=w(),c=m("audio"),d=w(),p=m("audio"),E=w(),T=m("audio"),y=w(),I=m("div");for(let N=0;N<$.length;N+=1)$[N].c();L=w(),z&&z.c(),D=w(),ht(O.$$.fragment),G=w(),Y&&Y.c(),te=bt(),Ue(r.src,o="audio/lucky.mp3")||_(r,"src",o),r.muted=l=n[8].muted,Ue(c.src,u="audio/farewell.mp3")||_(c,"src",u),c.muted=f=n[8].muted,Ue(p.src,g="audio/heDidItAgain.mp3")||_(p,"src",g),p.muted=v=n[8].muted,Ue(T.src,M="audio/fishCatch.mp3")||_(T,"src",M),T.muted=P=n[8].muted,_(I,"class","backgrounds")},m(N,U){for(let B=0;B<H.length;B+=1)H[B]&&H[B].m(ps.head,null);h(ps.head,e),V&&V.m(ps.head,null),h(ps.head,t),k(N,s,U),k(N,i,U),h(i,r),n[38](r),h(i,a),h(i,c),n[39](c),h(i,d),h(i,p),n[40](p),h(i,E),h(i,T),n[41](T),k(N,y,U),k(N,I,U);for(let B=0;B<$.length;B+=1)$[B]&&$[B].m(I,null);k(N,L,U),z&&z.m(N,U),k(N,D,U),st(O,N,U),k(N,G,U),Y&&Y.m(N,U),k(N,te,U),W=!0,oe||(ve=[Le(window,"storage",n[34]),Le(window,"wheel",n[35],{passive:!1}),Le(window,"keydown",n[36]),Le(window,"resize",n[37])],oe=!0)},p(N,U){if(U[0]&1073741824){j=Ce(N[30]);let B;for(B=0;B<j.length;B+=1){const ge=sl(N,j,B);H[B]?H[B].p(ge,U):(H[B]=il(ge),H[B].c(),H[B].m(e.parentNode,e))}for(;B<H.length;B+=1)H[B].d(1);H.length=j.length}if(N[24].component?V||(V=rl(),V.c(),V.m(t.parentNode,t)):V&&(V.d(1),V=null),(!W||U[0]&256&&l!==(l=N[8].muted))&&(r.muted=l),(!W||U[0]&256&&f!==(f=N[8].muted))&&(c.muted=f),(!W||U[0]&256&&v!==(v=N[8].muted))&&(p.muted=v),(!W||U[0]&256&&P!==(P=N[8].muted))&&(T.muted=P),U[0]&1077936128){Ee=Ce(N[30]);let B;for(B=0;B<Ee.length;B+=1){const ge=nl(N,Ee,B);$[B]?$[B].p(ge,U):($[B]=ol(ge),$[B].c(),$[B].m(I,null))}for(;B<$.length;B+=1)$[B].d(1);$.length=Ee.length}N[10]?z?(z.p(N,U),U[0]&1024&&Q(z,1)):(z=ll(N),z.c(),Q(z,1),z.m(D.parentNode,D)):z&&(mt(),ue(z,1,1,()=>{z=null}),gt()),U[0]&704&&(X=_n(N[7])&&_n(N[6])&&N[9]),X?Y?(Y.p(N,U),U[0]&704&&Q(Y,1)):(Y=al(N),Y.c(),Q(Y,1),Y.m(te.parentNode,te)):Y&&(mt(),ue(Y,1,1,()=>{Y=null}),gt())},i(N){W||(Q(z),Q(O.$$.fragment,N),Q(Y),W=!0)},o(N){ue(z),ue(O.$$.fragment,N),ue(Y),W=!1},d(N){N&&(S(s),S(i),S(y),S(I),S(L),S(D),S(G),S(te)),Xe(H,N),S(e),V&&V.d(N),S(t),n[38](null),n[39](null),n[40](null),n[41](null),Xe($,N),z&&z.d(N),it(O,N),Y&&Y.d(N),oe=!1,ot(ve)}}}let qi="v1.1.0";function js(n,e,t){return`${(n<10?"0":"")+n}<b> : </b>${(e<10?"0":"")+e}<b> : </b>${(t<10?"0":"")+t}`}function Lp(n,e,t){let s,i,r,o,l,a,c,u,f,d,p,g,v,E;me(n,Ct,b=>t(32,i=b)),me(n,sn,b=>t(4,r=b)),me(n,qs,b=>t(33,o=b)),me(n,ct,b=>t(5,l=b)),me(n,wo,b=>t(6,a=b)),me(n,Wi,b=>t(7,c=b)),me(n,rt,b=>t(8,u=b)),me(n,ss,b=>t(57,f=b)),me(n,Bt,b=>t(23,d=b)),me(n,tt,b=>t(24,p=b)),me(n,Bi,b=>t(58,g=b)),me(n,kn,b=>t(25,v=b)),me(n,rn,b=>t(26,E=b));let T,M,P=!1,y=7,I=[.2,.3,.45,.6,.75,.85,.95,1,1.1,1.25,1.5,1.75,2,2.5,3,4,5],L=!1,D,O,G={},X={},te=["version","builds","changelogSeen"],W,oe,ve,j,H;Tc(()=>{t(9,P=!0),g||(Z(Bi,g=!0,g),Z(tt,p.component=cc,p))});function V(){D=setTimeout(()=>{t(10,L=!1)},750)}function Ee(){clearTimeout(D),t(10,L=!0),V()}let $={equipment:19816,weapons:19818},z,Y,N=58,U=58,B=58,ge;function F(){let b=0;clearInterval(ge),z=Date.now()/1e3/60/60/24+b,t(18,Y={equipment:Math.floor(z)-$.equipment,weapons:Math.floor(z)-$.weapons});let Je=u.mode;l.gameNum!=Y[Je]+1&&(Z(ct,l=At.currentGameData[Je],l),Z(ct,l.gameNum=Y[Je]+1,l)),v_(y_(g_(x_))).then(kt=>{Z(wo,a={equipment:kt.val().rng_equipment_list[Y.equipment],weapons:kt.val().rng_weapons_list[Y.weapons]},a),t(31,G={equipment:kt.val().rng_equipment_list[Y.equipment-1],weapons:kt.val().rng_weapons_list[Y.weapons-1]})}),ge=setInterval(()=>{let kt=Date.now(),Pn=(Math.floor(z)+1-b)*24*60*60*1e3-kt;t(19,N=Math.floor(Pn/1e3/60/60)),t(20,U=Math.floor(Pn%(1e3*60*60)/(1e3*60))),t(21,B=Math.floor(Pn%(1e3*60)/1e3)),N==0&&U==0&&B==0&&(Z(ct,l=At.currentGameData[Je],l),Z(Bt,d.equipment=At.currentGameData.equipment,d),Z(Bt,d.weapons=At.currentGameData.weapons,d),setTimeout(F,1e3))},1e3)}F();let pe=["equipment","weapons"];for(let b of pe)fetch(`https://raw.githubusercontent.com/XT8SS/frontierdle/gh-pages/item-data/${b}Data.json`).then(async Je=>{if(Je.status!=200){console.error(`Failed to fetch ${b}!
Status: ${Je.status}`);return}let kt=await Je.json();Z(Wi,c[b]=kt.sort((Er,Pn)=>Er.name.toLowerCase().localeCompare(Pn.name.toLowerCase())),c)});let ne=[],J=[],Ie,ye,Ge=9;for(let b=0;b<Ge;b++)ne.push(`backgrounds/BG${b}.jpg`);function Be(b){ye=Math.floor(Math.random()*b.length)}Be(ne);function We(){t(22,Ie=ye),J.push(ye)}We(),function b(){setTimeout(()=>{if(Be(ne),!J.length)We();else if(J.length>3&&(J=J.slice(1)),!J.includes(ye))We();else{let Je=[...Array(Ge).keys()].filter(kt=>!J.includes(kt));Be(Je),We()}document.visibilityState=="visible"&&b()},45e3)}(),localStorage.getItem("fd-version")!=qi&&(Z(ss,f=!1,f),localStorage.setItem("fd-version",qi));function et(){Z(ct,l.gameWin=!0,l),Z(Ct,i.gamesPlayed++,i),Z(Ct,i.gamesWon++,i),Z(Ct,i.streak++,i),Z(Ct,i.winInfo[l.chosenItems.length]++,i),(l.chosenItems.length===1?H:i.streak>=3?j:oe).play()}function Ke(){Z(ct,l.gameOver=!0,l),Z(Ct,i.gamesPlayed++,i),Z(Ct,i.streak=0,i),ve.play()}const le=b=>{te.includes(b.key)?localStorage.setItem(b.key,b.oldValue):b.key=="fd-currentGameData"?b.url.includes("ls=true")?Z(Bt,d=JSON.parse(b.newValue),d):localStorage.setItem("fd-currentGameData",JSON.stringify(d)):b.key=="fd-settings"?b.url.includes("ls=true")?Z(rt,u=JSON.parse(b.newValue),u):localStorage.setItem("fd-settings",JSON.stringify(u)):b.key=="fd-playerStats"&&(b.url.includes("ls=true")?Z(kn,v=JSON.parse(b.newValue),v):localStorage.setItem("fd-playerStats",JSON.stringify(v)))},wt=b=>{let Je=b.wheelDeltaY;if(b.ctrlKey){if(b.preventDefault(),I[y]==.2&&Je<0||I[y]==5&&Je>0)return;Je>0?t(2,y++,y):t(2,y--,y),Ee()}},we=b=>{let Je=["Enter"," ","Escape"];b.ctrlKey&&(b.key=="-"||b.key=="+"||b.code=="Equal"||b.key=="0")&&(b.preventDefault(),(b.key=="+"||b.code=="Equal")&&I[y]!=5?t(2,y++,y):b.key=="-"&&I[y]!=.2?t(2,y--,y):b.key=="0"&&I[y]!=1&&t(2,y=7),Ee()),p.component&&W&&(!b.ctrlKey&&!b.shiftKey&&!b.altKey&&Je.includes(b.key)||b.key=="Tab")&&Z(tt,p.component=null,p)};function Se(){t(0,T=window.outerHeight),t(1,M=window.outerWidth)}function Oe(b){at[b?"unshift":"push"](()=>{oe=b,t(14,oe)})}function Me(b){at[b?"unshift":"push"](()=>{ve=b,t(15,ve)})}function fe(b){at[b?"unshift":"push"](()=>{j=b,t(16,j)})}function ke(b){at[b?"unshift":"push"](()=>{H=b,t(17,H)})}const ae=b=>{Pt(b),!E&&Z(rt,u.muted=!u.muted,u)},x=b=>{Pt(b),l.gameWin||l.gameOver?(location.hash="playerStats",xi()):(Z(tt,p.complete=!0,p),Z(tt,p.component=ac,p))},se=b=>{if(l.chosenItems.length){b.detail.checked=!b.detail.checked;return}Z(sn,r=b.detail.checked,r)};function Te(b){n.$$.not_equal(Y[s],b)&&(Y[s]=b,t(18,Y))}function de(b){n.$$.not_equal(Y[s],b)&&(Y[s]=b,t(18,Y))}function C(b){O=b,t(11,O),t(7,c),t(6,a),t(31,G)}function ie(b){at[b?"unshift":"push"](()=>{W=b,t(13,W)})}const R=b=>{W.children[0].contains(b.target)||(Z(tt,p.component=null,p),Z(tt,p.complete=!1,p))};function pt(b){at[b?"unshift":"push"](()=>{W=b,t(13,W)})}const uc=b=>{W.children[0].contains(b.target)||(Z(tt,p.component=null,p),Z(tt,p.complete=!1,p))};return n.$$.update=()=>{if(n.$$.dirty[0]&7&&(T||M)){let b=M>T;document.documentElement.style.fontSize=`${(b?.75:M/T*.8)*I[y]}vh`}n.$$.dirty[0]&256&&t(3,s=u.mode),n.$$.dirty[0]&192|n.$$.dirty[1]&1&&_n(c)&&_n(a)&&(t(11,O={equipment:c.equipment.find(b=>b.name==a.equipment),weapons:c.weapons.find(b=>b.name==a.weapons)}),t(12,X={equipment:c.equipment.find(b=>b.name==G.equipment),weapons:c.weapons.find(b=>b.name==G.weapons)})),n.$$.dirty[0]&16&&Z(qs,o=r?6:7,o),n.$$.dirty[0]&104|n.$$.dirty[1]&4&&l.chosenItems.length&&!l.gameWin&&!l.gameOver&&(l.chosenItems[l.chosenItems.length-1].name==a[s]?et():l.chosenItems.length==o&&Ke()),n.$$.dirty[1]&2&&i.streak>i.maxStreak&&Z(Ct,i.maxStreak=i.streak,i)},[T,M,y,s,r,l,a,c,u,P,L,O,X,W,oe,ve,j,H,Y,N,U,B,Ie,d,p,v,E,I,te,Ee,ne,G,i,o,le,wt,we,Se,Oe,Me,fe,ke,ae,x,se,Te,de,C,ie,R,pt,uc]}class Fp extends _t{constructor(e){super(),dt(this,e,Lp,Mp,lt,{},null,[-1,-1,-1])}}new Fp({target:document.body});
